...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_SUMMARY_s_v1(LOCATION_ID INT,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_TEST_SUMMARY_sna_v1(DC_NBR INT,
PERF_SMRY_TRAN_ID INT,
WHSE_sna_v1 STRING,
LOGIN_USER_ID STRING,
JOB_FUNCTION_NAME STRING,
SPVSR_LOGIN_USER_ID STRING,
DEPT_CODE_sna_v1 STRING,
CLOCK_IN_DATE TIMESTAMP,
CLOCK_IN_STATUS INT,
TOTAL_SAM INT,
TOTAL_PAM INT,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_USER_b_v1(LOCATION_ID INT,
WM_UCL_USER_ID INT,
WM_COMPANY_ID INT,
WM_LOCATION_ID INT,
WM_LOCALE_ID INT,
WM_USER_TYPE_ID INT,
ACTIVE_FLAG_b_v1 INT,
USER_NAME STRING,
TAX_ID_NBR STRING,
COMMON_NAME STRING,
USER_PREFIX STRING,
USER_TITLE_b_v1 STRING,
USER_FIRST_NAME STRING,
USER_MIDDLE_NAME STRING,
USER_LAST_NAME STRING,
BIRTH_DT DATE,

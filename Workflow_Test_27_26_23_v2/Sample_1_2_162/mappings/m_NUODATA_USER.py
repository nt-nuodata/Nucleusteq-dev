...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_NUODATA_USER_b_v1_3
...
query_3 = f"""SELECT
  ...
  ACTIVE_FLAG_b_v1 AS ACTIVE_FLAG_b_v1,
  USER_NAME AS USER_NAME,
  TAX_ID_NBR AS TAX_ID_NBR,
  COMMON_NAME AS COMMON_NAME,
  USER_PREFIX AS USER_PREFIX,
  USER_TITLE_b_v1 AS USER_TITLE_b_v1,
  USER_FIRST_NAME AS USER_FIRST_NAME,
  USER_MIDDLE_NAME AS USER_MIDDLE_NAME,
  USER_LAST_NAME AS USER_LAST_NAME,
...
df_3.createOrReplaceTempView("Shortcut_to_NUODATA_USER_b_v1_3")
...
query_4 = f"""SELECT
  ...
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_NUODATA_USER_b_v1_3
WHERE
  USER_NAME IN (
    SELECT
      USER_NAME
...
# COMMAND ----------
# DBTITLE 1, NUODATA_USER_b_v1


spark.sql("""MERGE INTO NUODATA_USER_b_v1 AS TARGET
USING
...
SET
  ...
  TARGET.ACTIVE_FLAG_b_v1 = SOURCE.IS_ACTIVE,
  ...
  TARGET.USER_TITLE_b_v1 = SOURCE.USER_TITLE1,
  ...
  AND TARGET.ACTIVE_FLAG_b_v1 = SOURCE.IS_ACTIVE
  ...
  AND TARGET.USER_TITLE_b_v1 = SOURCE.USER_TITLE1
...
INSERT
  (
    ...
    TARGET.ACTIVE_FLAG_b_v1,
    TARGET.USER_NAME,
    TARGET.TAX_ID_NBR,
    TARGET.COMMON_NAME,
    TARGET.USER_PREFIX,
    TARGET.USER_TITLE_b_v1,

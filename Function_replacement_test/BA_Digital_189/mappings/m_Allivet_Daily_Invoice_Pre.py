...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_Allivet_Daily_Invoice_Pre")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_Allivet_Daily_Invoice_Pre", variablesTableName, mainWorkflowId)
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_Allivet_Daily_Invoice_Pre")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_Allivet_Daily_Invoice_Pre", mainWorkflowId, parentName)

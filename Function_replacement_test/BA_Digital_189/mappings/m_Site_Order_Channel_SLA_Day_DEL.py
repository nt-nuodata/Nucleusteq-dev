...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_Site_Order_Channel_SLA_Day_DEL")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_Site_Order_Channel_SLA_Day_DEL", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_SITE_ORDER_CHANNEL_SLA_DAY1_0
...
df_0.createOrReplaceTempView("Shortcut_to_SITE_ORDER_CHANNEL_SLA_DAY1_0")
...
FROM
  Shortcut_to_SITE_ORDER_CHANNEL_SLA_DAY1_0"""
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_Site_Order_Channel_SLA_Day_DEL")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_Site_Order_Channel_SLA_Day_DEL", mainWorkflowId, parentName)

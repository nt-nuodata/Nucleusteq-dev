...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_DDS_OMS_Order_Line_Item_Attribute")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_DDS_OMS_Order_Line_Item_Attribute", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_OMS_ORDER_LINE_ITEM_ATTRIBUTE_PRE_0
...
df_0.createOrReplaceTempView("Shortcut_to_OMS_ORDER_LINE_ITEM_ATTRIBUTE_PRE_0")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_OMS_ORDER_LINE_ITEM_ATTRIBUTE_PRE_1
...
FROM
  Shortcut_to_OMS_ORDER_LINE_ITEM_ATTRIBUTE_PRE_0"""

df_1 = spark.sql(query_1)

df_1.createOrReplaceTempView("SQ_Shortcut_to_OMS_ORDER_LINE_ITEM_ATTRIBUTE_PRE_1")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_OMS_ORDER_LINE_ITEM_ATTRIBUTE_2
...
df_2.createOrReplaceTempView("Shortcut_to_OMS_ORDER_LINE_ITEM_ATTRIBUTE_2")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_OMS_ORDER_LINE_ITEM_ATTRIBUTE_3
...
query_3 = f"""SELECT
  ...
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_OMS_ORDER_LINE_ITEM_ATTRIBUTE_2"""

df_3 = spark.sql(query_3)

df_3.createOrReplaceTempView("SQ_Shortcut_to_OMS_ORDER_LINE_ITEM_ATTRIBUTE_3")

# COMMAND ----------
# DBTITLE 1, JNR_OMS_ORDER_LINE_ITEM_ATTRIBUTE_4
...
FROM
  SQ_Shortcut_to_OMS_ORDER_LINE_ITEM_ATTRIBUTE_3 MASTER
  RIGHT JOIN SQ_Shortcut_to_OMS_ORDER_LINE_ITEM_ATTRIBUTE_PRE_1 DETAIL ON MASTER.OMS_ORDER_ID = DETAIL.ORDER_ID
  AND MASTER.OMS_LINE_ITEM_ID = DETAIL.LINE_ITEM_ID
  AND MASTER.ATTRIBUTE_NAME = DETAIL.ATTRIBUTE_NAME
  AND MASTER.ATTRIBUTE_SEQ = DETAIL.ATTRIBUTE_SEQ"""

df_4 = spark.sql(query_4)

df_4.createOrReplaceTempView("JNR_OMS_ORDER_LINE_ITEM_ATTRIBUTE_4")
...
query_5 = f"""SELECT
  ...
  Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  JNR_OMS_ORDER_LINE_ITEM_ATTRIBUTE_4
WHERE
...
# COMMAND ----------
# DBTITLE 1, EXP_UNCHANGED_RECORDS_6
...
df_6.createOrReplaceTempView("EXP_UNCHANGED_RECORDS_6")
...
# COMMAND ----------
# DBTITLE 1, OMS_ORDER_LINE_ITEM_ATTRIBUTE


spark.sql("""MERGE INTO OMS_ORDER_LINE_ITEM_ATTRIBUTE AS TARGET
USING
  UPD_INSERT_UPDATE_7 AS SOURCE ON TARGET.OMS_LINE_ITEM_ID = SOURCE.LINE_ITEM_ID
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_DDS_OMS_Order_Line_Item_Attribute")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_DDS_OMS_Order_Line_Item_Attribute", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_Allivet_Daily_Order_Pre")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_Allivet_Daily_Order_Pre", variablesTableName, mainWorkflowId)
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_Allivet_Daily_Order_Pre")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_Allivet_Daily_Order_Pre", mainWorkflowId, parentName)

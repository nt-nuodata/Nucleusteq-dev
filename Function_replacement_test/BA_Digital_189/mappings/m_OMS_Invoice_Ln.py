...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_OMS_Invoice_Ln")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_OMS_Invoice_Ln", variablesTableName, mainWorkflowId)
...
FROM
  Exp_Fields_18
WHERE
  UPDATE_TSTMP_OMS_LPN_DDS > TRUNC(now())
  OR UPDATE_TSTMP_OMS_ORDER_LINE_ITEM > TRUNC(now())
  OR UPDATE_TSTMP_OMS_A_INVOICE_LINE > TRUNC(now())
  OR UPDATE_TSTMP_OMS_A_INVOICE > TRUNC(now())
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_OMS_Invoice_Ln")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_OMS_Invoice_Ln", mainWorkflowId, parentName)

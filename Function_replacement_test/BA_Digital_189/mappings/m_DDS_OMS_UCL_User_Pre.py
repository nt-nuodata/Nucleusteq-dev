...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_DDS_OMS_UCL_User_Pre")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_DDS_OMS_UCL_User_Pre", variablesTableName, mainWorkflowId)
...
WHERE
  (
    TRUNC(Shortcut_to_UCL_USER_0.CREATED_DTTM) >= TRUNC(now()) -7
  )
  OR (
    TRUNC(Shortcut_to_UCL_USER_0.LAST_UPDATED_DTTM) >= TRUNC(now()) -7
  )"""
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_DDS_OMS_UCL_User_Pre")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_DDS_OMS_UCL_User_Pre", mainWorkflowId, parentName)

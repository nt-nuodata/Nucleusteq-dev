...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_Digital_Forecast_Day")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_Digital_Forecast_Day", variablesTableName, mainWorkflowId)
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_DIGITAL_FORECAST_DAY_4
...
query_4 = f"""SELECT
  ...
  LOAD_TSTMP AS LOAD_TSTMP
FROM
  DIGITAL_FORECAST_DAY"""

df_4 = spark.sql(query_4)

df_4.createOrReplaceTempView("Shortcut_to_DIGITAL_FORECAST_DAY_4")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_DIGITAL_FORECAST_DAY_5
...
query_5 = f"""SELECT
  ...
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_DIGITAL_FORECAST_DAY_4"""

df_5 = spark.sql(query_5)

df_5.createOrReplaceTempView("SQ_Shortcut_to_DIGITAL_FORECAST_DAY_5")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_DIGITAL_FORECAST_WEEK_6
...
df_6.createOrReplaceTempView("Shortcut_to_DIGITAL_FORECAST_WEEK_6")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_DIGITAL_FORECAST_WEEK_7
...
query_7 = f"""SELECT
  ...
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_DIGITAL_FORECAST_WEEK_6"""

df_7 = spark.sql(query_7)

df_7.createOrReplaceTempView("SQ_Shortcut_to_DIGITAL_FORECAST_WEEK_7")
...
query_8 = f"""SELECT
  ...
  Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  SQ_Shortcut_to_DIGITAL_FORECAST_WEEK_7
WHERE
...
query_11 = f"""SELECT
  ...
  MASTER.FORECAST_SALES_AMT_USD AS FORECAST_SALES_AMT_USD,
  MASTER.FORECAST_MARGIN_AMT_USD AS FORECAST_MARGIN_AMT_USD,
  MASTER.FORECAST_ORDER_CNT AS FORECAST_ORDER_CNT,
...
query_13 = f"""SELECT
  ...
  DETAIL.FORECAST_SALES_AMT_USD AS FORECAST_SALES_AMT_USD,
  DETAIL.FORECAST_MARGIN_AMT_USD AS FORECAST_MARGIN_AMT_USD,
  DETAIL.FORECAST_ORDER_CNT AS FORECAST_ORDER_CNT,
...
query_14 = f"""SELECT
  ...
  MAX(
    DECODE (
      lkp_DAY_OF_WK_NBR,
      1,
      MON_SALES_PCT * FORECAST_SALES_AMT_USD,
      2,
      TUE_SALES_PCT * FORECAST_SALES_AMT_USD,
      3,
      WED_SALES_PCT * FORECAST_SALES_AMT_USD,
      4,
      THU_SALES_PCT * FORECAST_SALES_AMT_USD,
      5,
      FRI_SALES_PCT * FORECAST_SALES_AMT_USD,
      6,
      SAT_SALES_PCT * FORECAST_SALES_AMT_USD,
      7,
      SUN_SALES_PCT * FORECAST_SALES_AMT_USD
    )
  ) AS o_FORECAST_SALES_AMT_USD,
  MAX(
    DECODE (
      lkp_DAY_OF_WK_NBR,
      1,
      MON_MARGIN_PCT * FORECAST_MARGIN_AMT_USD,
      2,
      TUE_MARGIN_PCT * FORECAST_MARGIN_AMT_USD,
      3,
      WED_MARGIN_PCT * FORECAST_MARGIN_AMT_USD,
      4,
      THU_MARGIN_PCT * FORECAST_MARGIN_AMT_USD,
      5,
      FRI_MARGIN_PCT * FORECAST_MARGIN_AMT_USD,
      6,
      SAT_MARGIN_PCT * FORECAST_MARGIN_AMT_USD,
      7,
      SUN_MARGIN_PCT * FORECAST_MARGIN_AMT_USD
    )
  ) AS o_FORECAST_MARGIN_AMT_USD,
  MAX(
    DECODE (
      lkp_DAY_OF_WK_NBR,
      1,
      MON_ORDER_PCT * FORECAST_ORDER_CNT,
      2,
      TUE_ORDER_PCT * FORECAST_ORDER_CNT,
      3,
      WED_ORDER_PCT * FORECAST_ORDER_CNT,
      4,
      THU_ORDER_PCT * FORECAST_ORDER_CNT,
      5,
      FRI_ORDER_PCT * FORECAST_ORDER_CNT,
      6,
      SAT_ORDER_PCT * FORECAST_ORDER_CNT,
      7,
      SUN_ORDER_PCT * FORECAST_ORDER_CNT
    )
  ) AS o_FORECAST_ORDER_CNT,
  lkp_DAY_DT AS lkp_DAY_DT,
...
query_15 = f"""SELECT
  ...
  DETAIL.FISCAL_YR AS FISCAL_YR,
  DETAIL.FISCAL_WK AS FISCAL_WK,
  DETAIL.o_FORECAST_SALES_AMT_USD AS o_FORECAST_SALES_AMT_USD,
  DETAIL.o_FORECAST_MARGIN_AMT_USD AS o_FORECAST_MARGIN_AMT_USD,
  DETAIL.o_FORECAST_ORDER_CNT AS o_FORECAST_ORDER_CNT,
  ...
  MASTER.FORECAST_SALES_AMT_USD AS lkp_FORECAST_SALES_AMT_USD,
  MASTER.FORECAST_MARGIN_AMT_USD AS lkp_FORECAST_MARGIN_AMT_USD,
  MASTER.FORECAST_ORDER_CNT AS lkp_FORECAST_ORDER_CNT,
  MASTER.UPDATE_TSTMP AS lkp_UPDATE_TSTMP,
  MASTER.LOAD_TSTMP AS lkp_LOAD_TSTMP,
  DETAIL.Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  SQ_Shortcut_to_DIGITAL_FORECAST_DAY_5 MASTER
...
query_16 = f"""SELECT
  ...
  FISCAL_YR AS FISCAL_YR,
  FISCAL_WK AS FISCAL_WK,
  o_FORECAST_SALES_AMT_USD AS o_FORECAST_SALES_AMT_USD,
  o_FORECAST_MARGIN_AMT_USD AS o_FORECAST_MARGIN_AMT_USD,
  o_FORECAST_ORDER_CNT AS o_FORECAST_ORDER_CNT,
  lkp_DAY_DT AS lkp_DAY_DT,
  ...
  IFF (
    ...
    IFF (
      ...
      AND (
        IFF(
          ISNULL(o_FORECAST_SALES_AMT_USD),
          999999999.9999,
          o_FORECAST_SALES_AMT_USD
        ) <> IFF(
        ...
        OR IFF(
          ISNULL(o_FORECAST_MARGIN_AMT_USD),
          999999999.9999,
          o_FORECAST_MARGIN_AMT_USD
        ) <> IFF(
        ...
        OR IFF(
          ISNULL(o_FORECAST_ORDER_CNT),
          999999999.9999,
          o_FORECAST_ORDER_CNT
        ) <> IFF(
...
# COMMAND ----------
# DBTITLE 1, DIGITAL_FORECAST_DAY


spark.sql("""MERGE INTO DIGITAL_FORECAST_DAY AS TARGET
USING
...
SET
  ...
  TARGET.FORECAST_SALES_AMT_USD = SOURCE.o_FORECAST_SALES_AMT_USD,
  TARGET.FORECAST_MARGIN_AMT_USD = SOURCE.o_FORECAST_MARGIN_AMT_USD,
  TARGET.FORECAST_ORDER_CNT = SOURCE.o_FORECAST_ORDER_CNT,
  ...
  AND TARGET.FORECAST_SALES_AMT_USD = SOURCE.o_FORECAST_SALES_AMT_USD
  AND TARGET.FORECAST_MARGIN_AMT_USD = SOURCE.o_FORECAST_MARGIN_AMT_USD
  AND TARGET.FORECAST_ORDER_CNT = SOURCE.o_FORECAST_ORDER_CNT
...
VALUES
  (
    ...
    SOURCE.FISCAL_YR,
    SOURCE.FISCAL_WK,
    SOURCE.o_FORECAST_SALES_AMT_USD,
    SOURCE.o_FORECAST_MARGIN_AMT_USD,
    SOURCE.o_FORECAST_ORDER_CNT,
    SOURCE.UPDATE_TSTMP,
    SOURCE.o_LOAD_TSTMP
  )""")
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_Digital_Forecast_Day")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_Digital_Forecast_Day", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_OMS_Order_Load_Ctrl")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_OMS_Order_Load_Ctrl", variablesTableName, mainWorkflowId)
...
query_2 = f"""SELECT
  DISTINCT Shortcut_to_ORDERS_1.ORDER_ID AS ORDER_ID,
...
WHERE
  Shortcut_to_OMS_PURCH_ORDER_LOAD_CTRL_0.PURCHASE_ORDERS_ID = Shortcut_to_ORDERS_1.PURCHASE_ORDER_ID"""
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_OMS_Order_Load_Ctrl")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_OMS_Order_Load_Ctrl", mainWorkflowId, parentName)

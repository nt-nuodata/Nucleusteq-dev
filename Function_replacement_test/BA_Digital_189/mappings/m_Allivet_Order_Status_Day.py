...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_Allivet_Order_Status_Day")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_Allivet_Order_Status_Day", variablesTableName, mainWorkflowId)
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_Allivet_Order_Status_Day")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_Allivet_Order_Status_Day", mainWorkflowId, parentName)

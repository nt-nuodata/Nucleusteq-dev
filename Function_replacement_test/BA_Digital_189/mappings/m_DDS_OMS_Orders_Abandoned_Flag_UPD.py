...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_DDS_OMS_Orders_Abandoned_Flag_UPD")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_DDS_OMS_Orders_Abandoned_Flag_UPD", variablesTableName, mainWorkflowId)
...
WHERE
  LOAD_TSTMP >= DATE(CURRENT_TIMESTAMP)
  AND (
    UPPER(RETURN_DESC) LIKE '%ISPU CUSTOMER ABANDONMENT%'
    OR UPPER(RETURN_DESC) LIKE 'BUYER REMORSE %'
  )"""
...
FROM
  ...
  INNER JOIN EXP_OMS_Order_Source_2 DETAIL ON MASTER.OMS_ORDER_ID = DETAIL.OMS_ORDER_ID"""
...
ORDER BY
  ...
  o_UPDATE_TSTMP ASC,
  ABANDONED_OVERDUE_FLAG ASC"""

df_8 = spark.sql(query_8)

df_8.createOrReplaceTempView("SRT_Source_8")

# COMMAND ----------
# DBTITLE 1, FIL_Target_9
...
df_9.createOrReplaceTempView("FIL_Target_9")
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_DDS_OMS_Orders_Abandoned_Flag_UPD")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_DDS_OMS_Orders_Abandoned_Flag_UPD", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_DDS_OMS_Lpn_Detail_Pre")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_DDS_OMS_Lpn_Detail_Pre", variablesTableName, mainWorkflowId)
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_LPN_DETAIL_1
...
query_1 = f"""SELECT
  ...
  LPN_DETAIL_STATUS AS LPN_DETAIL_STATUS,
  INTERNAL_ORDER_DTL_ID AS INTERNAL_ORDER_DTL_ID,
  ...
  PURCHASE_ORDERS_LINE_ID AS PURCHASE_ORDERS_LINE_ID,
  TC_PURCHASE_ORDERS_LINE_ID AS TC_PURCHASE_ORDERS_LINE_ID,
  HIBERNATE_VERSION AS HIBERNATE_VERSION,
  INTERNAL_ORDER_ID AS INTERNAL_ORDER_ID,
  INSTRTN_CODE_1 AS INSTRTN_CODE_1,
  INSTRTN_CODE_2 AS INSTRTN_CODE_2,
  INSTRTN_CODE_3 AS INSTRTN_CODE_3,
  INSTRTN_CODE_4 AS INSTRTN_CODE_4,
  INSTRTN_CODE_5 AS INSTRTN_CODE_5,
  ...
  VENDOR_ITEM_NBR AS VENDOR_ITEM_NBR,
  MANUFACTURED_PLANT AS MANUFACTURED_PLANT,
  BATCH_NBR AS BATCH_NBR,
  ASSIGNED_QTY AS ASSIGNED_QTY,
  PREPACK_GROUP_CODE AS PREPACK_GROUP_CODE,
  PACK_CODE AS PACK_CODE,
  SHIPPED_QTY AS SHIPPED_QTY,
  INITIAL_QTY AS INITIAL_QTY,
  ...
  HAZMAT_UOM AS HAZMAT_UOM,
  HAZMAT_QTY AS HAZMAT_QTY,
...
df_1.createOrReplaceTempView("Shortcut_to_LPN_DETAIL_1")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_LPN_2
...
df_2.createOrReplaceTempView("Shortcut_to_LPN_2")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_LPN_DETAIL_3


query_3 = f"""SELECT
  Shortcut_to_LPN_DETAIL_1.LPN_ID AS LPN_ID,
  Shortcut_to_LPN_DETAIL_1.LPN_DETAIL_ID AS LPN_DETAIL_ID,
  Shortcut_to_LPN_DETAIL_1.DISTRIBUTION_ORDER_DTL_ID AS DISTRIBUTION_ORDER_DTL_ID,
  Shortcut_to_LPN_DETAIL_1.ITEM_ID AS ITEM_ID,
  Shortcut_to_LPN_DETAIL_1.ASN_DTL_ID AS ASN_DTL_ID,
  Shortcut_to_LPN_DETAIL_1.CREATED_DTTM AS CREATED_DTTM,
  Shortcut_to_LPN_DETAIL_1.LAST_UPDATED_DTTM AS LAST_UPDATED_DTTM,
  Shortcut_to_LPN_DETAIL_1.SHIPPED_QTY AS SHIPPED_QTY,
  Shortcut_to_LPN_DETAIL_1.ITEM_NAME AS ITEM_NAME,
  Shortcut_to_LPN_2.ORDER_ID AS ORDER_ID,
  Shortcut_to_LPN_2.LPN_ID AS LPN_ID1,
  Shortcut_to_OMS_ORDER_LOAD_CTRL_0.ORDER_ID AS ORDER_ID1,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_LPN_DETAIL_1,
  Shortcut_to_OMS_ORDER_LOAD_CTRL_0,
  Shortcut_to_LPN_2
WHERE
  Shortcut_to_LPN_2.LPN_ID = Shortcut_to_LPN_DETAIL_1.LPN_ID
  AND Shortcut_to_LPN_2.ORDER_ID = Shortcut_to_OMS_ORDER_LOAD_CTRL_0.ORDER_ID"""

df_3 = spark.sql(query_3)

df_3.createOrReplaceTempView("SQ_Shortcut_to_LPN_DETAIL_3")
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_DDS_OMS_Lpn_Detail_Pre")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_DDS_OMS_Lpn_Detail_Pre", mainWorkflowId, parentName)

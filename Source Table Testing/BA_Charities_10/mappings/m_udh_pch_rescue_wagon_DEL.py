...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_USR_PCH_RESCUE_WAGON_v2_0


df_0 = spark.sql("""SELECT
  RW_TRANS_DT_v2 AS RW_TRANS_DT_v2,
...
FROM
  USR_PCH_RESCUE_WAGON_v2""")

df_0.createOrReplaceTempView("Shortcut_to_USR_PCH_RESCUE_WAGON_v2_0")
...
df_1 = spark.sql("""SELECT
  RW_TRANS_DT_v2 AS RW_TRANS_DT,
  RW_ROUTE_ID AS RW_ROUTE_ID,
  UPDATE_TSTMP AS UPDATE_TSTMP,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_USR_PCH_RESCUE_WAGON_v2_0
WHERE

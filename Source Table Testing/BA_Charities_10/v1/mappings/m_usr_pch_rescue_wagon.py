...
# COMMAND ----------
# DBTITLE 1, USR_PCH_RESCUE_WAGON


spark.sql("""MERGE INTO USR_PCH_RESCUE_WAGON AS TARGET
USING
  UPD_ins_upd_6 AS SOURCE ON TARGET.RW_ROUTE_ID = SOURCE.RW_ROUTE_ID1
  AND TARGET.RW_TRANS_DT = SOURCE.RW_TRANS_DT1
  WHEN MATCHED
  AND SOURCE.UPDATE_STRATEGY_FLAG = "DD_UPDATE" THEN
UPDATE
SET
  TARGET.RW_TRANS_DT = SOURCE.RW_TRANS_DT1,

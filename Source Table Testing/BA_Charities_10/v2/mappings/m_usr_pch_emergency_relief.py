...
USING
  UPD_ins_upd_9 AS SOURCE ON TARGET.GRANT_REQ_ID_v2 = SOURCE.ER_GRANT_ID1
  AND TARGET.ER_SEQ_NO = SOURCE.ER_SEQ_NO1
  AND TARGET.ER_DT = SOURCE.ER_DT1
  WHEN MATCHED
  AND SOURCE.UPDATE_STRATEGY_FLAG = "DD_UPDATE" THEN
UPDATE
SET
  TARGET.GRANT_REQ_ID_v2 = SOURCE.ER_GRANT_ID1,

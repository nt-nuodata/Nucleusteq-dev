...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_WM_Ucl_User_PRE")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_WM_Ucl_User_PRE", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_UCL_USER_v2_0
...
df_0.createOrReplaceTempView("Shortcut_to_UCL_USER_v2_0")
...
FROM
  Shortcut_to_UCL_USER_v2_0
WHERE
  {Initial_Load} (
    trunc(Shortcut_to_UCL_USER_v2_0.CREATED_DTTM) >= trunc(to_date('{Prev_Run_Dt}', 'MM/DD/YYYY HH24:MI:SS')) - 1
  )
  OR (
    trunc(Shortcut_to_UCL_USER_v2_0.LAST_UPDATED_DTTM) >= trunc(to_date('{Prev_Run_Dt}', 'MM/DD/YYYY HH24:MI:SS')) - 1
  )
  AND 1 = 1"""
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_WM_Ucl_User_PRE")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_WM_Ucl_User_PRE", mainWorkflowId, parentName)

...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.E_DEPT_v2(DEPT_ID_v2 BIGINT,
DEPT_CODE STRING,
DESCRIPTION STRING,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.UCL_USER_v2(UCL_USER_ID BIGINT,
COMPANY_ID BIGINT,
USER_NAME STRING,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.WM_E_CONSOL_PERF_SMRY_PRE_v2(DC_NBR_v2 INT,

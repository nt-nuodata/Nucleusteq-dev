...
# parentNames = parentNames + ", m_Last_Run_Dt"

# COMMAND ----------

fetchAndCreateVariables(parentName, "m_Last_Run_Dt", variablesTableName, mainWorkflowId)
...
FROM
  Shortcut_to_DAYS_0
WHERE
  CAST(DAY_DT AS DATE) = CURRENT_DATE""")
...
updateMappingVariable(variablesTableName, "m_Last_Run_Dt", mainWorkflowId, parentName)

# COMMAND ----------

#postsession_success_variable_assignment
variables = {"wf_Last_Run_Dt" : "Last_Run_Dt"}
updateVariable(variables, variablesTableName, mainWorkflowId, "m_Last_Run_Dt",parentName)

# COMMAND ----------

#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_Last_Run_Dt", mainWorkflowId, parentName)

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM WM_YARD;

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT count(*) FROM WM_YARD;
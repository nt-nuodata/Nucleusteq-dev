...
targetTables = ["DELTA_TRAINING.WM_E_CONSOL_PERF_SMRY_PRE"]
...
updateVariable(variables, variablesTableName, mainWorkflowId, parentName, "m_WM_E_Consol_Perf_Smry_PRE")
...
# DC_NBR = 14
fetchAndCreateVariables(parentName, "m_WM_E_Consol_Perf_Smry_PRE", variablesTableName, mainWorkflowId)
...
# MAGIC %sql
# MAGIC SELECT * FROM DELTA_TRAINING.WM_E_CONSOL_PERF_SMRY_PRE;

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT count(*) FROM DELTA_TRAINING.WM_E_CONSOL_PERF_SMRY_PRE;

# COMMAND ----------

persistVariables(variablesTableName, "m_WM_E_Consol_Perf_Smry_PRE", mainWorkflowId, parentName)
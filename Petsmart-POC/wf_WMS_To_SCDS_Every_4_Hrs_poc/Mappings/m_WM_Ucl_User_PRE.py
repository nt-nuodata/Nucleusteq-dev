...
print(mainWorkflowId) 
print(mainWorkflowRunId)
print(variablesTableName) 
print(parentName)
print(canTruncateTargetTables)

# COMMAND ----------

#Truncate Target Tables
targetTables = ["DELTA_TRAINING.WM_UCL_USER_PRE"]
truncateTargetTables(targetTables, canTruncateTargetTables)

# COMMAND ----------

#Pre session variable updation
variables = {"Prev_Run_Dt" : "wk_Last_Run_Dt"}
updateVariable(variables, variablesTableName, mainWorkflowId, parentName, "m_WM_Ucl_User_PRE")
...
# MAGIC %sql
# MAGIC SELECT * FROM DELTA_TRAINING.WM_UCL_USER_PRE;

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT count(*) FROM DELTA_TRAINING.WM_UCL_USER_PRE;

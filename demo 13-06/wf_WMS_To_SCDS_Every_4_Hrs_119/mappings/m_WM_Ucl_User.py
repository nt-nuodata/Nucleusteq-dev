...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_WM_UCL_USER_v2_3


df_3 = spark.sql("""SELECT
  LOCATION_ID_v2 AS LOCATION_ID_v2,
  WM_UCL_USER_ID AS WM_UCL_USER_ID,
  WM_COMPANY_ID_v2 AS WM_COMPANY_ID_v2,
...
df_3.createOrReplaceTempView("Shortcut_to_WM_UCL_USER_v2_3")
...
# COMMAND ----------
# DBTITLE 1, WM_UCL_USER_v2


spark.sql("""MERGE INTO WM_UCL_USER_v2 AS TARGET
USING
  UPD_INS_UPD_11 AS SOURCE ON TARGET.LOCATION_ID_v2 = SOURCE.LOCATION_ID1
  AND TARGET.USER_NAME = SOURCE.USER_NAME1
  WHEN MATCHED
  AND SOURCE.UPDATE_STRATEGY_FLAG = "DD_UPDATE" THEN
UPDATE
SET
  TARGET.LOCATION_ID_v2 = SOURCE.LOCATION_ID1,
  TARGET.WM_UCL_USER_ID = SOURCE.UCL_USER_ID,
  TARGET.WM_COMPANY_ID_v2 = SOURCE.COMPANY_ID,
  ...
  AND TARGET.WM_COMPANY_ID_v2 = SOURCE.COMPANY_ID
...
INSERT
  (
    TARGET.LOCATION_ID_v2,
    TARGET.WM_UCL_USER_ID,
    TARGET.WM_COMPANY_ID_v2,

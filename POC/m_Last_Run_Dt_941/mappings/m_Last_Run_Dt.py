...
df_2=spark.sql("""SELECT DAY_DT AS DAY_DT,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_Shortcut_to_DAYS_1""")
...
spark.sql("""INSERT INTO WM_YARD SELECT null AS LOCATION_ID,
null AS WM_YARD_ID,
...
DAY_DT AS LOAD_TSTMP FROM FIL_FALSE_3""")
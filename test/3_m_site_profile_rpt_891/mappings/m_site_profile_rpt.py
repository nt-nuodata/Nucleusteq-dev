...
df_16=spark.sql("""SELECT REGION_ID AS REGION_ID,
iif(IN(REGION_ID, 200, 300, 850,400), 1,
iif(IN(REGION_ID, 775, 800,950,500), 4,
iif(IN(REGION_ID, 650),5, 
REGION_ID))) AS SUPER_REGION_ID,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM JNR_Detail_Outer_Join_4""")
...
df_17=spark.sql("""
    SELECT
        ...
        EXP_SUPER_REGION_16.SUPER_REGION_ID AS SUPER_REGION_ID1,
        EXP_SUPER_REGION_16.Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        SUPER_REGION 
    RIGHT OUTER JOIN
        EXP_SUPER_REGION_16 
            ON SUPER_REGION.SUPER_REGION_ID = EXP_SUPER_REGION_16.SUPER_REGION_ID""")
...
df_21=spark.sql("""SELECT TO_BIGINT(LKP_DM_PG_STORE_7.PURCH_GROUP_ID) AS o_PURCH_GROUP_ID,
TO_INTEGER(JNR_Detail_Outer_Join_4.REGION_ID) AS o_REGION_ID,
TO_INTEGER(JNR_Detail_Outer_Join_4.DISTRICT_ID) AS o_DISTRICT_ID,
LKP_DM_PG_STORE_7.Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM LKP_DM_PG_STORE_7 INNER JOIN JNR_Detail_Outer_Join_4 ON LKP_DM_PG_STORE_7.Monotonically_Increasing_Id = JNR_Detail_Outer_Join_4.Monotonically_Increasing_Id
""")
...
df_30=spark.sql("""SELECT JNR_Detail_Outer_Join_4.LOCATION_ID AS LOCATION_ID,
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID AS LOCATION_TYPE_ID,
RTRIM(LKP_LOCATION_TYPE_14.LOCATION_TYPE_DESC) AS o_LOCATION_TYPE_DESC,
...
RTRIM(LKP_STORE_TYPE_11.STORE_TYPE_DESC) AS o_STORE_TYPE_DESC,
...
RTRIM(LKP_COMPANY_5.COMPANY_DESC) AS o_COMPANY_DESC,
SUPER_REGION_ID1 AS SUPER_REGION_ID,
LKP_SUPER_REGION_17.SUPER_REGION_DESC AS SUPER_REGION_DESC,
...
RTRIM(LKP_DISTRICT_12.DISTRICT_DESC) AS o_DISTRICT_DESC,
...
RTRIM(LKP_STATE_8.STATE_NAME) AS o_STATE_NAME,
JNR_Detail_Outer_Join_4.POSTAL_CD AS POSTAL_CD,
JNR_Detail_Outer_Join_4.COUNTRY_CD AS COUNTRY_CD,
RTRIM(LKP_COUNTRY_6.COUNTRY_NAME) AS o_COUNTRY_NAME,
...
LKP_SLSCMP_STORE_13.SALES_CURR_FLAG AS SALES_CURR_FLAG,
JNR_Detail_Outer_Join_4.SITE_OPEN_YRS_AMT AS SITE_OPEN_YRS_AMT,
LKP_SLSCMP_STORE_13.FIRST_SALE_DT AS FIRST_SALE_DT,
LKP_SLSCMP_STORE_13.FIRST_MEASURED_SALE_DT AS FIRST_MEASURED_SALE_DT,
LKP_SLSCMP_STORE_13.LAST_SALE_DT AS LAST_SALE_DT,
LKP_SLSCMP_STORE_13.COMP_CURR_FLAG AS COMP_CURR_FLAG,
LKP_SLSCMP_STORE_13.COMP_EFF_DT AS COMP_EFF_DT,
LKP_SLSCMP_STORE_13.COMP_END_DT AS COMP_END_DT,
...
SUBSTR(LKP_STORE_TIME_ZONE_18.TIME_ZONE, 1, 3) AS o_TIME_ZONE_ID,
...
RTRIM(LKP_PRICE_ZONE_10.PRICE_ZONE_DESC) AS o_PRICE_ZONE_DESC,
...
RTRIM(LKP_EQUINE_MERCH_9.EQUINE_MERCH_DESC) AS o_EQUINE_MERCH_DESC,
...
DECODE(ISNULL(JNR_Detail_Outer_Join_4.SITE_MANAGER_ID), 0, JNR_Detail_Outer_Join_4.SITE_MANAGER_ID) AS o_SITE_MANAGER_ID,
JNR_Detail_Outer_Join_4.EMPL_FIRST_NAME || ' ' || JNR_Detail_Outer_Join_4.EMPL_LAST_NAME AS SITE_MANAGER_NAME,
...
o_PURCH_GROUP_ID AS PURCH_GROUP_ID,
LKP_DM_PG_MGR_DVL_23.PURCH_GROUP_NAME AS PURCH_GROUP_NAME,
LKP_SALES_RANKING_WK_15.TOTAL_SALES_RANKING_CD AS TOTAL_SALES_RANKING_CD,
LKP_SALES_RANKING_WK_15.MERCH_SALES_RANKING_CD AS MERCH_SALES_RANKING_CD,
LKP_SALES_RANKING_WK_15.SERVICES_SALES_RANKING_CD AS SERVICES_SALES_RANKING_CD,
LKP_SALES_RANKING_WK_15.SALON_SALES_RANKING_CD AS SALON_SALES_RANKING_CD,
LKP_SALES_RANKING_WK_15.TRAINING_SALES_RANKING_CD AS TRAINING_SALES_RANKING_CD,
LKP_SALES_RANKING_WK_15.HOTEL_DDC_SALES_RANKING_CD AS HOTEL_DDC_SALES_RANKING_CD,
LKP_SALES_RANKING_WK_15.CONSUMABLES_SALES_RANKING_CD AS CONSUMABLES_SALES_RANKING_CD,
LKP_SALES_RANKING_WK_15.HARDGOODS_SALES_RANKING_CD AS HARDGOODS_SALES_RANKING_CD,
LKP_SALES_RANKING_WK_15.SPECIALTY_SALES_RANKING_CD AS SPECIALTY_SALES_RANKING_CD,
...
DECODE(TRUE, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=1 ,'N/A', 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=2 ,'N/A', 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=3 ,'N/A', 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=4 ,'N/A', 
...
DECODE(TRUE,
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=1,LKP_USR_DC_NAMES_19.DC_RLPM_NAME, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=2,LKP_USR_DC_NAMES_19.DC_RLPM_NAME, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=3,LKP_USR_DC_NAMES_19.DC_RLPM_NAME, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=4,LKP_USR_DC_NAMES_19.DC_RLPM_NAME, 
...
DECODE(TRUE,
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=1,LKP_USR_DC_NAMES_19.DC_RLPM_EMAIL, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=2,LKP_USR_DC_NAMES_19.DC_RLPM_EMAIL, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=3,LKP_USR_DC_NAMES_19.DC_RLPM_EMAIL, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=4,LKP_USR_DC_NAMES_19.DC_RLPM_EMAIL, 
...
DECODE(TRUE, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=1 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER1_NAME, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=2 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER1_NAME, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=3 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER1_NAME, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=4 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER1_NAME, 
LKP_USR_DISTRICT_NAMES_24.HR_SUPER_NAME) AS HR_SUPERVISOR_NAME1,
LKP_USR_DISTRICT_NAMES_24.HR_SUPER_EMAIL AS HR_SUPER_EMAIL,
DECODE(TRUE, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=1 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER1_EMAIL, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=2 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER1_EMAIL, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=3 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER1_EMAIL, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=4 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER1_EMAIL, 
...
DECODE(TRUE, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=1 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER2_NAME, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=2 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER2_NAME, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=3 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER2_NAME, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=4 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER2_NAME, 
'') AS HR_SUPERVISOR_NAME2,
DECODE(TRUE, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=1 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER2_EMAIL, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=2 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER2_EMAIL, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=3 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER2_EMAIL, 
JNR_Detail_Outer_Join_4.LOCATION_TYPE_ID=4 ,LKP_USR_DC_NAMES_19.DC_HR_SUPER2_EMAIL, 
...
LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM LKP_LOYALTY_PGM_STATUS_29 INNER JOIN LKP_EQUINE_SITE_28 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_EQUINE_SITE_28.Monotonically_Increasing_Id
 INNER JOIN LKP_USR_DISTRICT_NAMES_24 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_USR_DISTRICT_NAMES_24.Monotonically_Increasing_Id
 INNER JOIN LKP_REGION_27 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_REGION_27.Monotonically_Increasing_Id
 INNER JOIN LKP_PETSMART_DMA_26 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_PETSMART_DMA_26.Monotonically_Increasing_Id
 INNER JOIN LKP_LOYALTY_PGM_TYPE_25 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_LOYALTY_PGM_TYPE_25.Monotonically_Increasing_Id
 INNER JOIN EXP_Conv_21 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = EXP_Conv_21.Monotonically_Increasing_Id
 INNER JOIN LKP_PRICE_AD_ZONE_20 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_PRICE_AD_ZONE_20.Monotonically_Increasing_Id
 INNER JOIN LKP_USR_DC_NAMES_19 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_USR_DC_NAMES_19.Monotonically_Increasing_Id
 INNER JOIN LKP_STORE_TIME_ZONE_18 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_STORE_TIME_ZONE_18.Monotonically_Increasing_Id
 INNER JOIN JNR_Detail_Outer_Join_4 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = JNR_Detail_Outer_Join_4.Monotonically_Increasing_Id
 INNER JOIN LKP_STORE_TYPE_11 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_STORE_TYPE_11.Monotonically_Increasing_Id
 INNER JOIN LKP_DISTRICT_12 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_DISTRICT_12.Monotonically_Increasing_Id
 INNER JOIN LKP_SLSCMP_STORE_13 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_SLSCMP_STORE_13.Monotonically_Increasing_Id
 INNER JOIN LKP_LOCATION_TYPE_14 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_LOCATION_TYPE_14.Monotonically_Increasing_Id
 INNER JOIN LKP_COUNTRY_6 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_COUNTRY_6.Monotonically_Increasing_Id
 INNER JOIN LKP_STATE_8 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_STATE_8.Monotonically_Increasing_Id
 INNER JOIN LKP_EQUINE_MERCH_9 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_EQUINE_MERCH_9.Monotonically_Increasing_Id
 INNER JOIN LKP_DM_PG_MGR_DVL_23 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_DM_PG_MGR_DVL_23.Monotonically_Increasing_Id
 INNER JOIN LKP_PRICE_ZONE_10 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_PRICE_ZONE_10.Monotonically_Increasing_Id
 INNER JOIN LKP_SALES_RANKING_WK_15 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_SALES_RANKING_WK_15.Monotonically_Increasing_Id
 INNER JOIN LKP_USR_REGION_NAMES_22 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_USR_REGION_NAMES_22.Monotonically_Increasing_Id
 INNER JOIN LKP_SUPER_REGION_17 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_SUPER_REGION_17.Monotonically_Increasing_Id
 INNER JOIN LKP_COMPANY_5 ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_COMPANY_5.Monotonically_Increasing_Id
""")

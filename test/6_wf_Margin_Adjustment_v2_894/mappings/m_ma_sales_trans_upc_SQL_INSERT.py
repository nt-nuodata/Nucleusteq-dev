...
df_4=spark.sql("""SELECT TO_CHAR(START_TSTMP_output, 'MM/DD/YYYY HH24:MI:SS') AS START_TSTMP,
...
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQL_INS_and_DUPS_CHECK_3""")
...
df_6=spark.sql("""SELECT START_TSTMP AS START_TSTMP,
...
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM AGG_5""")
...
df_8=spark.sql("""SELECT DUPLICATE_ROW_CNT_output AS DUPLICATE_ROW_CNT,
...
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQL_INS_to_SQL_TRANSFORM_LOG_7""")

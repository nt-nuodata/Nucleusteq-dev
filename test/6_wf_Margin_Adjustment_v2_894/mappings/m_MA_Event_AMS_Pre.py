...
SEQ_MA_EVENT_ID.Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SEQ_MA_EVENT_ID INNER JOIN MA_EVENT_NEW_7 ON SEQ_MA_EVENT_ID.Monotonically_Increasing_Id = MA_EVENT_NEW_7.Monotonically_Increasing_Id
""")

...
df_6=spark.sql("""SELECT LOAD_DT AS LOAD_DT,
MA_EVENT_ID AS MA_EVENT_ID,
PRODUCT_ID AS PRODUCT_ID,
COUNTRY_CD AS COUNTRY_CD,
START_DT AS START_DT,
...
MA_AMT AS MA_AMT,
MA_MAX_AMT AS MA_MAX_AMT,
iif(INS_UPD_DEL_FLAG='R','U',INS_UPD_DEL_FLAG) AS INS_UPD_DEL_FLAG_out,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM FTR_MA_EVENT_RESTATE_HIST_5""")
...
INS_UPD_DEL_FLAG_out AS INS_UPD_DEL_FLAG,
INS_UPD_DEL_FLAG_out AS INS_UPD_DEL_FLAG,
INS_UPD_DEL_FLAG_out AS INS_UPD_DEL_FLAG FROM EXP_MA_EVENT_RESTATE_HIST_6""")
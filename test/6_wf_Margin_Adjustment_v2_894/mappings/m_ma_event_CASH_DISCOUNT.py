...
SEQ_MA_EVENT_ID.Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SEQ_MA_EVENT_ID INNER JOIN SQ_USR_MA_DEF_ALLOW_CTRL_INSERTS_4 ON SEQ_MA_EVENT_ID.Monotonically_Increasing_Id = SQ_USR_MA_DEF_ALLOW_CTRL_INSERTS_4.Monotonically_Increasing_Id
""")
...
SYSDATE AS UPDATE_DT,
LOAD_DT AS LOAD_DT,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_USR_MA_DEF_ALLOW_CTRL_UPDATES_6""")
...
df_9=spark.sql("""SELECT TRUNC(SYSDATE) AS LOAD_DT,
MA_EVENT_ID AS MA_EVENT_ID,
START_DT AS START_DT,
END_DT AS END_DT,
MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
...
LOAD_DT AS LOAD_DT1,
INS_UPD_DEL_FLAG AS INS_UPD_DEL_FLAG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM UNI_NEW_ORIG_8""")

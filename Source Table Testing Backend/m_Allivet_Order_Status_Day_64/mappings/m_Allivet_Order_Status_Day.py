...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_ALLIVET_ORDER_STATUS_DAY_v2_v3_0


df_0 = spark.sql("""SELECT
  ALLIVET_ORDER_NBR AS ALLIVET_ORDER_NBR,
  RX_HOLD_DT_v2_v3 AS RX_HOLD_DT_v2_v3,
  OPEN_DT AS OPEN_DT,
  COMPLETE_DT_v2_v3 AS COMPLETE_DT_v2_v3,
  VOID_DT AS VOID_DT,
  UPDATE_TSTMP AS UPDATE_TSTMP,
  LOAD_TSTMP AS LOAD_TSTMP
FROM
  ALLIVET_ORDER_STATUS_DAY_v2_v3""")

df_0.createOrReplaceTempView("Shortcut_to_ALLIVET_ORDER_STATUS_DAY_v2_v3_0")
...
df_1 = spark.sql("""SELECT
  ALLIVET_ORDER_NBR AS ALLIVET_ORDER_NBR,
  RX_HOLD_DT_v2_v3 AS RX_HOLD_DT,
  OPEN_DT AS OPEN_DT,
  COMPLETE_DT_v2_v3 AS COMPLETE_DT,
  VOID_DT AS VOID_DT,
  UPDATE_TSTMP AS UPDATE_TSTMP,
  LOAD_TSTMP AS LOAD_TSTMP,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_ALLIVET_ORDER_STATUS_DAY_v2_v3_0""")
...
SET
  ...
  TARGET.RX_HOLD_DT_v2 = SOURCE.o_RX_HOLD_DT,
  TARGET.OPEN_DT = SOURCE.o_OPEN_DT,
  TARGET.COMPLETE_DT_v2 = SOURCE.o_COMPLETE_DT,
  TARGET.VOID_DT = SOURCE.o_VOID_DT,
  TARGET.UPDATE_TSTMP = SOURCE.UPDATE_TSTMP,
  TARGET.LOAD_TSTMP = SOURCE.LOAD_TSTMP
  WHEN MATCHED
  AND SOURCE.UPDATE_STRATEGY_FLAG = "DD_DELETE"
  AND TARGET.RX_HOLD_DT_v2 = SOURCE.o_RX_HOLD_DT
  AND TARGET.OPEN_DT = SOURCE.o_OPEN_DT
  AND TARGET.COMPLETE_DT_v2 = SOURCE.o_COMPLETE_DT
...
INSERT
  (
    ...
    TARGET.RX_HOLD_DT_v2,
    TARGET.OPEN_DT,
    TARGET.COMPLETE_DT_v2,
    TARGET.VOID_DT,
    TARGET.UPDATE_TSTMP,
    TARGET.LOAD_TSTMP
  )

...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_NUODATA_USER_both_v1_3
...
query_3 = f"""SELECT
  ...
  WM_LOCALE_ID_both_v1 AS WM_LOCALE_ID_both_v1,
  WM_USER_TYPE_ID AS WM_USER_TYPE_ID,
  ACTIVE_FLAG AS ACTIVE_FLAG,
  USER_NAME AS USER_NAME,
  TAX_ID_NBR_both_v1 AS TAX_ID_NBR_both_v1,
  COMMON_NAME AS COMMON_NAME,
  USER_PREFIX AS USER_PREFIX,
  USER_TITLE AS USER_TITLE,
  USER_FIRST_NAME AS USER_FIRST_NAME,
  ...
  LOAD_TSTMP AS LOAD_TSTMP
FROM
  NUODATA_USER_both_v1"""

df_3 = spark.sql(query_3)

df_3.createOrReplaceTempView("Shortcut_to_NUODATA_USER_both_v1_3")
...
query_4 = f"""SELECT
  ...
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_NUODATA_USER_both_v1_3
WHERE
  USER_NAME IN (
    SELECT
      USER_NAME
...
# COMMAND ----------
# DBTITLE 1, NUODATA_USER_both_v1


spark.sql("""MERGE INTO NUODATA_USER_both_v1 AS TARGET
USING
...
SET
  ...
  AND TARGET.WM_LOCALE_ID_both_v1 = SOURCE.LOCALE_ID
  AND TARGET.WM_USER_TYPE_ID = SOURCE.USER_TYPE_ID
  AND TARGET.ACTIVE_FLAG = SOURCE.IS_ACTIVE
  AND TARGET.TAX_ID_NBR_both_v1 = SOURCE.TAX_ID_NBR
...
INSERT
  (
    ...
    TARGET.WM_LOCALE_ID_both_v1,
    TARGET.WM_USER_TYPE_ID,
    TARGET.ACTIVE_FLAG,
    TARGET.USER_NAME,
    TARGET.TAX_ID_NBR_both_v1,
    TARGET.COMMON_NAME,
    TARGET.USER_PREFIX,
    TARGET.USER_TITLE,

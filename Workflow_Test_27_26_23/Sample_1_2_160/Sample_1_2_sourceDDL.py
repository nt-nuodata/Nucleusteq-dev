...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.TEST_DEPARTMENT(DEPT_ID BIGINT,
DEPT_CODE STRING,
DESCRIPTION STRING,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.TEST_USER(UCL_USER_ID BIGINT,
COMPANY_ID BIGINT,
USER_NAME STRING,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.TEST_SUMMARY(PERF_SMRY_TRAN_ID BIGINT,
WHSE STRING,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_SUMMARY_source_v1(LOCATION_ID_source_v1 INT,
WM_PERF_SMRY_TRAN_ID INT,
WM_WHSE STRING,
WM_LOGIN_USER_ID STRING,
WM_JOB_FUNCTION_NAME STRING,
CLOCK_IN_TSTMP TIMESTAMP,
CLOCK_OUT_TSTMP_source_v1 TIMESTAMP,
CLOCK_IN_STATUS INT,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_TEST_SUMMARY_source_na_v2(DC_NBR INT,
PERF_SMRY_TRAN_ID INT,
WHSE_source_na_v2 STRING,
LOGIN_USER_ID_na_v2 STRING,
JOB_FUNCTION_NAME STRING,
SPVSR_LOGIN_USER_ID STRING,
DEPT_CODE STRING,
CLOCK_IN_DATE TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_USER_both_v1(LOCATION_ID INT,
WM_UCL_USER_ID INT,
WM_COMPANY_ID INT,
WM_LOCATION_ID INT,
WM_LOCALE_ID_both_v1 INT,
WM_USER_TYPE_ID INT,
ACTIVE_FLAG INT,
USER_NAME STRING,
TAX_ID_NBR_both_v1 STRING,
COMMON_NAME STRING,
USER_PREFIX STRING,
USER_TITLE STRING,
USER_FIRST_NAME STRING,

...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_NUODATA_TEST_USER_0
...
# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_NUODATA_TEST_USER_1
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_NUODATA_USER_b_v2_3


query_3 = f"""SELECT
  LOCATION_ID_b_v1 AS LOCATION_ID_b_v1,
  WM_UCL_USER_ID_b_v1 AS WM_UCL_USER_ID_b_v1,
  WM_COMPANY_ID AS WM_COMPANY_ID,
  WM_LOCATION_ID AS WM_LOCATION_ID,
  WM_LOCALE_ID AS WM_LOCALE_ID,
  WM_USER_TYPE_ID_b_v2 AS WM_USER_TYPE_ID_b_v2,
...
df_3.createOrReplaceTempView("Shortcut_to_NUODATA_USER_b_v2_3")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_NUODATA_USER_4


query_4 = f"""SELECT
  LOCATION_ID_b_v1 AS LOCATION_ID,
  WM_UCL_USER_ID_b_v1 AS WM_UCL_USER_ID,
  WM_CREATED_TSTMP AS WM_CREATED_TSTMP,
  WM_LAST_UPDATED_TSTMP AS WM_LAST_UPDATED_TSTMP,
  LOAD_TSTMP AS LOAD_TSTMP,
  USER_NAME AS USER_NAME,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_NUODATA_USER_b_v2_3
WHERE
  USER_NAME IN (
    SELECT
      USER_NAME
...
# COMMAND ----------
# DBTITLE 1, NUODATA_USER_b_v2


spark.sql("""MERGE INTO NUODATA_USER_b_v2 AS TARGET
USING
  UPD_INS_UPD_11 AS SOURCE ON TARGET.USER_NAME = SOURCE.USER_NAME1
  AND TARGET.LOCATION_ID_b_v1 = SOURCE.LOCATION_ID1
  WHEN MATCHED
  AND SOURCE.UPDATE_STRATEGY_FLAG = "DD_UPDATE" THEN
UPDATE
SET
  TARGET.LOCATION_ID_b_v1 = SOURCE.LOCATION_ID1,
  TARGET.WM_UCL_USER_ID_b_v1 = SOURCE.UCL_USER_ID,
  TARGET.WM_COMPANY_ID = SOURCE.COMPANY_ID,
  TARGET.WM_LOCATION_ID = SOURCE.LOCATION_ID2,
  TARGET.WM_LOCALE_ID = SOURCE.LOCALE_ID,
  TARGET.WM_USER_TYPE_ID_b_v2 = SOURCE.USER_TYPE_ID,
  ...
  AND TARGET.WM_UCL_USER_ID_b_v1 = SOURCE.UCL_USER_ID
  ...
  AND TARGET.WM_USER_TYPE_ID_b_v2 = SOURCE.USER_TYPE_ID
...
INSERT
  (
    TARGET.LOCATION_ID_b_v1,
    TARGET.WM_UCL_USER_ID_b_v1,
    TARGET.WM_COMPANY_ID,
    TARGET.WM_LOCATION_ID,
    TARGET.WM_LOCALE_ID,
    TARGET.WM_USER_TYPE_ID_b_v2,
    TARGET.ACTIVE_FLAG,
    TARGET.USER_NAME,
    TARGET.TAX_ID_NBR,
    TARGET.COMMON_NAME,

...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_SUMMARY_s_v2(LOCATION_ID_s_v1 INT,
WM_PERF_SMRY_TRAN_ID INT,
WM_WHSE STRING,
WM_LOGIN_USER_ID STRING,
WM_JOB_FUNCTION_NAME STRING,
CLOCK_IN_TSTMP_s_v1 TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_TEST_SUMMARY_sna_v1(DC_NBR_sna_v1 INT,
PERF_SMRY_TRAN_ID INT,
WHSE STRING,
LOGIN_USER_ID_sna_v1 STRING,
JOB_FUNCTION_NAME STRING,
SPVSR_LOGIN_USER_ID STRING,
DEPT_CODE STRING,
CLOCK_IN_DATE TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_USER_b_v2(LOCATION_ID_b_v1 INT,
WM_UCL_USER_ID_b_v1 INT,
WM_COMPANY_ID INT,
WM_LOCATION_ID INT,
WM_LOCALE_ID INT,
WM_USER_TYPE_ID_b_v2 INT,
ACTIVE_FLAG INT,
USER_NAME STRING,
TAX_ID_NBR STRING,
COMMON_NAME STRING,

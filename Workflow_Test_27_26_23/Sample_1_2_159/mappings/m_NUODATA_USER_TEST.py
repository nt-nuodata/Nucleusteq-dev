...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_TEST_USER_source_v1_0


query_0 = f"""SELECT
  UCL_USER_ID_source_v1 AS UCL_USER_ID_source_v1,
...
df_0.createOrReplaceTempView("Shortcut_to_TEST_USER_source_v1_0")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_TEST_USER_1


query_1 = f"""SELECT
  UCL_USER_ID_source_v1 AS UCL_USER_ID,
  COMPANY_ID AS COMPANY_ID,
  USER_NAME AS USER_NAME,
  USER_PASSWORD AS USER_PASSWORD,
  IS_ACTIVE AS IS_ACTIVE,
...
FROM
  Shortcut_to_TEST_USER_source_v1_0
WHERE
  $$Initial_Load (
    date_trunc(
      'DAY',
      Shortcut_to_TEST_USER_source_v1_0.CREATED_DTTM
    ) >= date_trunc(
      'DAY',
      to_date(
        DATE_FORMAT(
  ...
  OR (
    date_trunc(
      'DAY',
      Shortcut_to_TEST_USER_source_v1_0.LAST_UPDATED_DTTM
    ) >= date_trunc(
      'DAY',
      to_date(
        DATE_FORMAT(

...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_TEST_LOCATIONS_both_v1_5
...
query_5 = f"""SELECT
  ...
  LOAD_DT AS LOAD_DT
FROM
  TEST_LOCATIONS_both_v1"""

df_5 = spark.sql(query_5)

df_5.createOrReplaceTempView("Shortcut_to_TEST_LOCATIONS_both_v1_5")
...
query_6 = f"""SELECT
  ...
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_TEST_LOCATIONS_both_v1_5"""

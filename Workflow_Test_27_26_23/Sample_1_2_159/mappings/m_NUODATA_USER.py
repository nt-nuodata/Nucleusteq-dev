...
query_3 = f"""SELECT
  LOCATION_ID_both_v1 AS LOCATION_ID_both_v1,
...
query_4 = f"""SELECT
  LOCATION_ID_both_v1 AS LOCATION_ID,
  WM_UCL_USER_ID AS WM_UCL_USER_ID,
  WM_CREATED_TSTMP AS WM_CREATED_TSTMP,
  WM_LAST_UPDATED_TSTMP AS WM_LAST_UPDATED_TSTMP,
  LOAD_TSTMP AS LOAD_TSTMP,
...
USING
  ...
  AND TARGET.LOCATION_ID_both_v1 = SOURCE.LOCATION_ID1
  WHEN MATCHED
  AND SOURCE.UPDATE_STRATEGY_FLAG = "DD_UPDATE" THEN
UPDATE
SET
  TARGET.LOCATION_ID_both_v1 = SOURCE.LOCATION_ID1,

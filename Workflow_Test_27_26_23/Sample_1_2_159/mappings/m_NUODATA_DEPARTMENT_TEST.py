...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_TEST_DEPARTMENT_target_v1_0


query_0 = f"""SELECT
  DEPT_ID_target_v1 AS DEPT_ID_target_v1,
...
FROM
  TEST_DEPARTMENT_target_v1"""

df_0 = spark.sql(query_0)

df_0.createOrReplaceTempView("Shortcut_to_TEST_DEPARTMENT_target_v1_0")
...
FROM
  Shortcut_to_TEST_DEPARTMENT_target_v1_0
WHERE
  $$Initial_Load (

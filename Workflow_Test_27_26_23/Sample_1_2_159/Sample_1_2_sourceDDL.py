...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_SUMMARY_v2_NA(LOCATION_ID_v2_NA INT,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_TEST_SUMMARY_source_v1(DC_NBR_source_v1 INT,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_USER_both_v1(LOCATION_ID_both_v1 INT,
WM_UCL_USER_ID INT,
WM_COMPANY_ID INT,
WM_LOCATION_ID INT,
WM_LOCALE_ID INT,

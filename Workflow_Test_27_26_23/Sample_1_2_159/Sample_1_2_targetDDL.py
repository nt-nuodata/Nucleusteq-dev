...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_TEST_SUMMARY_v2_NA(DC_NBR_v2_NA INT,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_SUMMARY_target_v1(LOCATION_ID_target_v1 INT,

...
SEQ_MA_EVENT_ID.Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SEQ_MA_EVENT_ID INNER JOIN SQ_USR_MA_DC_COST_CTRL_INSERTS_4 ON SEQ_MA_EVENT_ID.Monotonically_Increasing_Id = SQ_USR_MA_DC_COST_CTRL_INSERTS_4.Monotonically_Increasing_Id
""")
...
df_7=spark.sql("""SELECT MA_EVENT_ID AS MA_EVENT_ID,
...
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_USR_MA_DC_COST_CTRL_UPDATES_6""")
...
df_10=spark.sql("""SELECT TRUNC(SYSDATE) AS LOAD_DT,
MA_EVENT_ID AS MA_EVENT_ID,
ORIG_START_DT AS ORIG_START_DT,
ORIG_END_DT AS ORIG_END_DT,
MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
...
LOAD_DT AS LOAD_DT1,
INS_UPD_FLAG AS INS_UPD_FLAG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM UN_INS_UPD_DEL_8""")
...
INS_UPD_FLAG AS INS_UPD_DEL_FLAG,
INS_UPD_FLAG AS INS_UPD_DEL_FLAG,
INS_UPD_FLAG AS INS_UPD_DEL_FLAG FROM EXP_INS_UPD_10""")
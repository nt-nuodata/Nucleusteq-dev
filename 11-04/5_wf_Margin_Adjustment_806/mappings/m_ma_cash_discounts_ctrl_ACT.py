...
df_15=spark.sql("""SELECT FISCAL_MO AS FISCAL_MO,
VENDOR_ID1 AS SOURCE_VENDOR_ID,
ACT_CASH_DISCOUNT_GL_AMT AS ACT_CASH_DISCOUNT_GL_AMT,
ACT_NET_SALES_COST AS ACT_NET_SALES_COST,
IIF(
IIF( ISNULL(ACT_NET_SALES_COST),0,ACT_NET_SALES_COST) = 0,0,
ACT_CASH_DISCOUNT_GL_AMT / ACT_NET_SALES_COST) AS THIS_ACT_CASH_DISCOUNT_PCT,
SYSDATE AS UPDATE_TSTMP,
IIF(ISNULL(LOAD_TSTMP),SYSDATE,LOAD_TSTMP) AS LOAD_TSTMP,
IIF(ISNULL(FISCAL_MO),'I',IIF(IIF(
IIF( ISNULL(ACT_NET_SALES_COST),0,ACT_NET_SALES_COST) = 0,0,
ACT_CASH_DISCOUNT_GL_AMT / ACT_NET_SALES_COST) <> IIF(ISNULL(ACT_CASH_DISCOUNT_PCT),0,ACT_CASH_DISCOUNT_PCT),'U','X')) AS INS_UPD_FLAG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM JNR_MA_CASH_DISCOUNT_14""")
...
ACT_NET_SALES_COST AS ACT_NET_SALES_COST,
ACT_CASH_DISCOUNT_GL_AMT AS ACT_CASH_DISCOUNT_GL_AMT,
THIS_ACT_CASH_DISCOUNT_PCT AS ACT_CASH_DISCOUNT_PCT,

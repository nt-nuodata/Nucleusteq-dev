...
df_4=spark.sql("""SELECT (ROW_NUMBER() OVER(ORDER BY(SELECT NULL))-1) * (SELECT Increment_By FROM SEQ_MA_EVENT_ID) + (SELECT NEXTVAL FROM SEQ_MA_EVENT_ID) AS MA_EVENT_ID,
...
SEQ_MA_EVENT_ID.Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SEQ_MA_EVENT_ID INNER JOIN ASQ_MA_EVENT_NEW_3 ON SEQ_MA_EVENT_ID.Monotonically_Increasing_Id = ASQ_MA_EVENT_NEW_3.Monotonically_Increasing_Id
""")

...
LOAD_DT AS LOAD_DT,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_MA_DC_COST_ADJ_CTRL_UPDATES_4""")
...
df_7=spark.sql("""SELECT (ROW_NUMBER() OVER(ORDER BY(SELECT NULL))-1) * (SELECT Increment_By FROM SEQ_MA_EVENT_ID) + (SELECT NEXTVAL FROM SEQ_MA_EVENT_ID) AS MA_EVENT_ID,
...
SEQ_MA_EVENT_ID.Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SEQ_MA_EVENT_ID INNER JOIN SQ_MA_DC_COST_ADJ_CTRL_INSERTS_6 ON SEQ_MA_EVENT_ID.Monotonically_Increasing_Id = SQ_MA_DC_COST_ADJ_CTRL_INSERTS_6.Monotonically_Increasing_Id
""")

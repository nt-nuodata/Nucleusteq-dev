...
df_2=spark.sql("""SELECT MA_EVENT_ID AS MA_EVENT_ID,
OFFER_ID AS OFFER_ID,
START_DT AS START_DT,
END_DT AS END_DT,
MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
...
VENDOR_NAME_TXT AS VENDOR_NAME_TXT,
'I' AS LOAD_FLG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_Shortcut_to_MA_EVENT_AMS_PRE_1""")
...
df_5=spark.sql("""SELECT MA_EVENT_ID AS MA_EVENT_ID,
OFFER_ID AS OFFER_ID,
START_DT AS START_DT,
END_DT AS END_DT,
MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
...
VENDOR_FUNDED_IND = 0 OR DELETE_FLAG = 1 OR  OFFER_AS_DISC_IND = 0,'D',

IIF(ISNULL(START_DT),TO_DATE('12319999','MMDDYYYY'),START_DT) <> IIF(ISNULL(tgt_START_DT),TO_DATE('12319999','MMDDYYYY'),tgt_START_DT) 
OR IIF(ISNULL(END_DT),TO_DATE('12319999','MMDDYYYY'),END_DT) <> IIF(ISNULL(tgt_END_DT),TO_DATE('12319999','MMDDYYYY'),tgt_END_DT) 
OR IIF(ISNULL(MA_PCT_IND),9,MA_PCT_IND) <> IIF(ISNULL(tgt_MA_PCT_IND),9,tgt_MA_PCT_IND)
OR IIF(ISNULL(MA_AMT),999999,MA_AMT) <> IIF(ISNULL(tgt_MA_AMT),999999,tgt_MA_AMT),'R',

IIF(ISNULL(MA_EVENT_DESC),' ',MA_EVENT_DESC) <> IIF(ISNULL(tgt_MA_EVENT_DESC),' ',tgt_MA_EVENT_DESC)
OR IIF(ISNULL(VENDOR_NAME_TXT),' ',VENDOR_NAME_TXT) <> IIF(ISNULL(tgt_VENDOR_NAME_TXT),' ',tgt_VENDOR_NAME_TXT)
OR IIF(ISNULL(MA_MAX_AMT),999999,MA_MAX_AMT) <> IIF(ISNULL(tgt_MA_MAX_AMT),999999,tgt_MA_MAX_AMT),'U',
'N') AS LOAD_FLAG,
tgt_MA_MAX_AMT AS tgt_MA_MAX_AMT,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_Shortcut_to_MA_EVENT_4""")
...
df_8=spark.sql("""SELECT MA_EVENT_ID AS MA_EVENT_ID,
OFFER_ID AS OFFER_ID,
START_DT AS START_DT,
END_DT AS END_DT,
MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
...
VENDOR_NAME_TXT AS VENDOR_NAME_TXT,
LOAD_FLG AS LOAD_FLG,
SYSDATE AS CURRENT_TSTMP,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM Union_7""")
...
df_11=spark.sql("""SELECT MA_EVENT_ID AS MA_EVENT_ID,
OFFER_ID AS OFFER_ID,
START_DT AS START_DT,
END_DT AS END_DT,
MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
...
MA_MAX_AMT AS MA_MAX_AMT,
VENDOR_NAME_TXT AS VENDOR_NAME_TXT,
IIF(LOAD_FLG = 'R', 'U', LOAD_FLG) AS o_LOAD_FLG,
TRUNC(SYSDATE) AS LOAD_DT,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM FIL_LoadFlag_10""")
...
o_LOAD_FLG AS INS_UPD_DEL_FLAG,
o_LOAD_FLG AS INS_UPD_DEL_FLAG FROM UPD_InsertOnly_12""")
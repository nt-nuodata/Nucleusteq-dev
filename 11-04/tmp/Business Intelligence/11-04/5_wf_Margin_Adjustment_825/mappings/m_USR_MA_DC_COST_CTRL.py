...
df_2=spark.sql("""SELECT MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
SAP_CATEGORY_ID AS SAP_CATEGORY_ID,
LOCATION_TYPE_ID AS LOCATION_TYPE_ID,
COMPANY_ID AS COMPANY_ID,
FISCAL_MO AS FISCAL_MO,
DC_COST_PCT AS DC_COST_PCT,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_Shortcut_to_USR_MA_DC_COST_CTRL_1""")

...
df_6=spark.sql("""SELECT (ROW_NUMBER() OVER(ORDER BY(SELECT NULL))-1) * (SELECT Increment_By FROM SEQ_MA_EVENT_ID) + (SELECT NEXTVAL FROM SEQ_MA_EVENT_ID) AS MA_EVENT_ID,
...
SEQ_MA_EVENT_ID.Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SEQ_MA_EVENT_ID INNER JOIN SQ_Shortcut_to_SERVICES_MARGIN_RATE_Ins_5 ON SEQ_MA_EVENT_ID.Monotonically_Increasing_Id = SQ_Shortcut_to_SERVICES_MARGIN_RATE_Ins_5.Monotonically_Increasing_Id
""")
...
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_Shortcut_to_SERVICES_MARGIN_RATE_Upd_7""")
...
MA_AMT AS MA_AMT,
MA_MAX_AMT AS MA_MAX_AMT,
IIF(LOAD_FLAG = 'R', 'U', LOAD_FLAG) AS LOAD_FLAG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM UNI_SERVICES_MARGIN_RATE_9""")
...
LOAD_FLAG AS INS_UPD_DEL_FLAG,
LOAD_FLAG AS INS_UPD_DEL_FLAG,
LOAD_FLAG AS INS_UPD_DEL_FLAG FROM EXP_INS_11""")

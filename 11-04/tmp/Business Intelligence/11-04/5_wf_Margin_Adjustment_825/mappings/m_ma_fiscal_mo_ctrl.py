...
df_4=spark.sql("""SELECT DAY_DT AS RESTATE_DT,
IIF(FISCAL_MO_NBR = 1,FISCAL_MO - 89,FISCAL_MO - 1) AS FISCAL_MO,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_Shortcut_To_DAYS_3""")
...
df_6=spark.sql("""SELECT FISCAL_MO AS FISCAL_MO,
RESTATE_DT AS RESTATE_DT,
SYSDATE AS UPDATE_TSTMP,
IIF (ISNULL(LOAD_TSTMP),SYSDATE,LOAD_TSTMP) AS LOAD_TSTMP,
IIF (ISNULL(FISCAL_MO1),'I','U') AS INS_UPD_FLAG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM JNR_FISCAL_MO_5""")

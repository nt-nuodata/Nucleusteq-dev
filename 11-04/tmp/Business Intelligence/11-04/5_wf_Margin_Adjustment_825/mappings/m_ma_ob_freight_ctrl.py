...
df_10=spark.sql("""SELECT FROM_LOCATION_ID AS FROM_LOCATION_ID,
FISCAL_MO AS FISCAL_MO,
R12_NET_SALES_COST AS R12_NET_SALES_COST,
R12_OB_FREIGHT_COST AS R12_OB_FREIGHT_COST,
R12_OB_FREIGHT_PCT AS R12_OB_FREIGHT_PCT,
...
'U' AS INS_UPD_FLAG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_MA_OB_FREIGHT_CTRL_UPD_9""")
...
df_12=spark.sql("""SELECT FROM_LOCATION_ID AS FROM_LOCATION_ID,
FISCAL_MO AS FISCAL_MO,
R12_NET_SALES_COST AS R12_NET_SALES_COST,
R12_OB_FREIGHT_COST AS R12_OB_FREIGHT_COST,
R12_OB_FREIGHT_PCT AS R12_OB_FREIGHT_PCT,
...
SYSDATE AS LOAD_TSTMP,
'I' AS INS_UPD_FLAG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_MA_OB_FREIGHT_CTRL_INS_11""")

...
df_6=spark.sql("""SELECT MA_EVENT_ID AS MA_EVENT_ID,
...
LOAD_DT AS LOAD_DT,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_Shortcut_to_MA_EVENT1_5""")
...
df_8=spark.sql("""SELECT (ROW_NUMBER() OVER(ORDER BY(SELECT NULL))-1) * (SELECT Increment_By FROM SEQ_MA_EVENT_ID) + (SELECT NEXTVAL FROM SEQ_MA_EVENT_ID) AS MA_EVENT_ID,
...
SEQ_MA_EVENT_ID.Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SEQ_MA_EVENT_ID INNER JOIN SQ_Shortcut_to_MA_EVENT_7 ON SEQ_MA_EVENT_ID.Monotonically_Increasing_Id = SQ_Shortcut_to_MA_EVENT_7.Monotonically_Increasing_Id
""")
...
df_11=spark.sql("""SELECT TRUNC(SYSDATE) AS LOAD_DT,
MA_EVENT_ID AS MA_EVENT_ID,
ORIG_START_DT AS ORIG_START_DT,
ORIG_END_DT AS ORIG_END_DT,
ORIG_MA_EVENT_TYPE_ID AS ORIG_MA_EVENT_TYPE_ID,
...
ORIG_MA_AMT AS ORIG_MA_AMT,
INS_UPD_DEL_FLAG AS INS_UPD_DEL_FLAG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM UNI_NEW_ORIG_9""")
...
NEW_END_DT AS END_DT,
NEW_END_DT AS END_DT,
NEW_MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
NEW_MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
NEW_MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
NEW_MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
NEW_MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
...
NEW_MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
NEW_MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
NEW_MA_EVENT_SOURCE_ID AS MA_EVENT_SOURCE_ID,
NEW_MA_EVENT_SOURCE_ID AS MA_EVENT_SOURCE_ID,
NEW_MA_EVENT_SOURCE_ID AS MA_EVENT_SOURCE_ID,
NEW_MA_EVENT_SOURCE_ID AS MA_EVENT_SOURCE_ID,
NEW_MA_EVENT_SOURCE_ID AS MA_EVENT_SOURCE_ID,
...
MOVEMENT_ID AS MOVEMENT_ID,
VALUATION_CLASS_CD AS VALUATION_CLASS_CD,
NEW_GL_ACCT_NBR AS GL_ACCT_NBR,
LOCATION_TYPE_ID AS LOCATION_TYPE_ID,
LOCATION_TYPE_ID AS LOCATION_TYPE_ID,
ROYALTY_BRAND_ID AS ROYALTY_BRAND_ID,
BRAND_CD AS BRAND_CD,
...
SOURCE_VENDOR_ID AS SOURCE_VENDOR_ID,
COMPANY_ID AS COMPANY_ID,
NEW_MA_EVENT_DESC AS MA_EVENT_DESC,
NEW_MA_EVENT_DESC AS MA_EVENT_DESC,
NEW_MA_EVENT_DESC AS MA_EVENT_DESC,
NEW_MA_EVENT_DESC AS MA_EVENT_DESC,
NEW_MA_EVENT_DESC AS MA_EVENT_DESC,

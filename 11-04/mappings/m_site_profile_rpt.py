...
df_21=spark.sql("""
    SELECT
        (CAST(LKP_DM_PG_STORE_7.PURCH_GROUP_ID AS DECIMAL (38,
        ...
        0))) AS o_DISTRICT_ID,
        LKP_DM_PG_STORE_7.Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        LKP_DM_PG_STORE_7 
    INNER JOIN
        JNR_Detail_Outer_Join_4 
            ON LKP_DM_PG_STORE_7.Monotonically_Increasing_Id = JNR_Detail_Outer_Join_4.Monotonically_Increasing_Id""")
...
df_30=spark.sql("""
    ...
    INNER JOIN
        LKP_STORE_TYPE_11 
            ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_STORE_TYPE_11.Monotonically_Increasing_Id 
    INNER JOIN
        LKP_DISTRICT_12 
            ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_DISTRICT_12.Monotonically_Increasing_Id 
    INNER JOIN
        LKP_SLSCMP_STORE_13 
            ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_SLSCMP_STORE_13.Monotonically_Increasing_Id 
    INNER JOIN
        LKP_LOCATION_TYPE_14 
            ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_LOCATION_TYPE_14.Monotonically_Increasing_Id 
    INNER JOIN
        LKP_COUNTRY_6 
            ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_COUNTRY_6.Monotonically_Increasing_Id 
    INNER JOIN
        LKP_STATE_8 
            ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_STATE_8.Monotonically_Increasing_Id 
    INNER JOIN
        LKP_EQUINE_MERCH_9 
            ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_EQUINE_MERCH_9.Monotonically_Increasing_Id 
    INNER JOIN
    ...
    INNER JOIN
        LKP_PRICE_ZONE_10 
            ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_PRICE_ZONE_10.Monotonically_Increasing_Id 
    INNER JOIN
        LKP_SALES_RANKING_WK_15 
            ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_SALES_RANKING_WK_15.Monotonically_Increasing_Id 
    INNER JOIN
    ...
    INNER JOIN
        LKP_SUPER_REGION_17 
            ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_SUPER_REGION_17.Monotonically_Increasing_Id 
    INNER JOIN
        LKP_COMPANY_5 
            ON LKP_LOYALTY_PGM_STATUS_29.Monotonically_Increasing_Id = LKP_COMPANY_5.Monotonically_Increasing_Id""")

...
df_15=spark.sql("""
    SELECT
        ...
        ACT_CASH_DISCOUNT_GL_AMT AS ACT_CASH_DISCOUNT_GL_AMT,
        ACT_NET_SALES_COST AS ACT_NET_SALES_COST,
        IFF(IFF(ISNULL(ACT_NET_SALES_COST),
        0,
        ACT_NET_SALES_COST) = 0,
        0,
        ...
        'I',
        IFF(IFF(IFF(ISNULL(ACT_NET_SALES_COST),
        0,
        ACT_NET_SALES_COST) = 0,
        0,
        ACT_CASH_DISCOUNT_GL_AMT / ACT_NET_SALES_COST) <> IFF(ISNULL(ACT_CASH_DISCOUNT_PCT),
        0,

...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_E_DEPT_v3_0


df_0 = spark.sql("""SELECT
  DEPT_ID_v3 AS DEPT_ID_v3,
...
df_0.createOrReplaceTempView("Shortcut_to_E_DEPT_v3_0")

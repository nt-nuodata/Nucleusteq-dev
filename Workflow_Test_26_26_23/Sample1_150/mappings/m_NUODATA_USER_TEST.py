...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_TEST_USER_0
...
WHERE
  {Initial_Load} (
    date_trunc('DAY', Shortcut_to_UCL_USER_0.CREATED_DTTM) >= date_trunc(
      'DAY',
      to_date(
        DATE_FORMAT(
  ...
  OR (
    date_trunc('DAY', Shortcut_to_UCL_USER_0.LAST_UPDATED_DTTM) >= date_trunc(
      'DAY',
      to_date(
        DATE_FORMAT(
          CAST({Prev_Run_Dt} AS timestamp),

...
ORDER_CHG_DT AS ORDER_CHG_DT,
ALLIVET_ORDER_DT AS ALLIVET_ORDER_DT,
IIF(ISNULL(ALLIVET_ORDER_NBR),ALLIVET_ORDER_NBR1,ALLIVET_ORDER_NBR) AS ALLIVET_ORDER_NBR_New,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM JNRTRANS_8""")
...
df_11=spark.sql("""SELECT IIF(ISNULL(ALLIVET_ORDER_NBR_New),ALLIVET_ORDER_NBR_New,ALLIVET_ORDER_NBR_New) AS ALLIVET_ORDER_NBR_New,
ORDER_CHG_DT AS ORDER_CHG_DT,
ALLIVET_ORDER_DT AS ALLIVET_ORDER_DT,
...
INVOICE_POSTING_DT
 AS COMPLETE_DT,
IIF((INSTR(LTRIM(RTRIM(UPPER(OPERATION))),UPPER('VoidSO'))>0),ORDER_CHG_DT,NULL) AS VOID_DT,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM JNRTRANS1_10""")
...
IIF( ISNULL (IIF( (ISNULL(o_RX_HOLD_DT)  and Not isnull(o_ALLIVET_ORDER_DT)) , o_ALLIVET_ORDER_DT,o_RX_HOLD_DT)),LKP_RX_HOLD_DT , IIF( (ISNULL(o_RX_HOLD_DT)  and Not isnull(o_ALLIVET_ORDER_DT)) , o_ALLIVET_ORDER_DT,o_RX_HOLD_DT)) AS o_RX_HOLD_DT,
IIF(ISNULL(o_OPEN_DT),LKP_OPEN_DT,o_OPEN_DT) AS o_OPEN_DT,
IIF(ISNULL(o_COMPLETE_DT),LKP_COMPLETE_DT,o_COMPLETE_DT) AS o_COMPLETE_DT,
IIF(ISNULL(o_VOID_DT),LKP_VOID_DT,o_VOID_DT) AS o_VOID_DT,
IIF(
...
(IIF (ISNULL
		(IIF( ISNULL 
		(IIF( (ISNULL(o_RX_HOLD_DT)  
			and Not isnull(o_ALLIVET_ORDER_DT)) , o_ALLIVET_ORDER_DT,o_RX_HOLD_DT)),LKP_RX_HOLD_DT , IIF( (ISNULL(o_RX_HOLD_DT)  
				and Not isnull(o_ALLIVET_ORDER_DT)) , o_ALLIVET_ORDER_DT,o_RX_HOLD_DT))),TO_DATE('9999-12-31','YYYY-MM-DD'),IIF( (ISNULL(o_RX_HOLD_DT)  
and Not isnull(o_ALLIVET_ORDER_DT)) , o_ALLIVET_ORDER_DT,o_RX_HOLD_DT)) <> IIF(ISNULL(LKP_RX_HOLD_DT),TO_DATE('9999-12-31','YYYY-MM-DD'),LKP_RX_HOLD_DT) 
)
OR 
IIF( ISNULL(o_OPEN_DT),TO_DATE('9999-12-31','YYYY-MM-DD'),o_OPEN_DT) <> IIF(ISNULL(LKP_OPEN_DT),TO_DATE('9999-12-31','YYYY-MM-DD'),LKP_OPEN_DT)
OR 
IIF( ISNULL(o_VOID_DT),TO_DATE('9999-12-31','YYYY-MM-DD'),o_VOID_DT) <> IIF(ISNULL(LKP_VOID_DT),TO_DATE('9999-12-31','YYYY-MM-DD'),LKP_VOID_DT)
OR 
IIF( ISNULL(o_COMPLETE_DT),TO_DATE('9999-12-31','YYYY-MM-DD'),o_COMPLETE_DT) <> IIF(ISNULL(LKP_COMPLETE_DT),TO_DATE('9999-12-31','YYYY-MM-DD'),LKP_COMPLETE_DT)),2,0)) AS UPDATE_FLAG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM Jnr_Order_Status_14""")
...
IIF(UPDATE_FLAG=1,o_ALLIVET_ORDER_DT,o_RX_HOLD_DT)
 ...
 AS o_RX_HOLD_DT1,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM Ftr_Insert_Update_16""")

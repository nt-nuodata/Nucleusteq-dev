...
df_8=spark.sql("""SELECT INVOICE_POSTING_DATE AS INVOICE_POSTING_DATE,
INVOICE_CODE AS INVOICE_CODE,
TRANSACTION_TYPE AS TRANSACTION_TYPE,
ALLIVET_ORDER_CODE AS ALLIVET_ORDER_CODE,
ALLIVET_SKU AS ALLIVET_SKU,
...
IIF((ISNULL(LKP_INVOICE_POSTING_DT) OR ISNULL(LKP_INVOICE_CD) OR ISNULL(LKP_TXN_TYPE) OR ISNULL(LKP_ALLIVET_ORDER_NBR) OR ISNULL(LKP_ALLIVET_SKU_NBR)),1,2) AS UPDATE_FLAG,
RETAIL_PRICE AS RETAIL_PRICE,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM Jnr_Insert_Update_7""")

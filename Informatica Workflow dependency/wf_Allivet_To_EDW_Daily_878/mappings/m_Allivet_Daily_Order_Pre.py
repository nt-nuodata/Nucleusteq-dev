...
df_2=spark.sql("""SELECT AllivetOrderCode AS AllivetOrderCode,
PetsmartOrderCode AS PetsmartOrderCode,
...
ShippingMethodCode AS ShippingMethodCode,
OrderStatus AS OrderStatus,
IIF(Upper(IsVoided)='FALSE','0',IIF(Upper(IsVoided)='TRUE','1',IsVoided)) AS o_IsVoided,
IIF(Upper(IsOnHold)='FALSE','0',IIF(Upper(IsOnHold)='TRUE','1',IsOnHold)) AS o_IsOnHold,
TO_DATE(SalesOrderDateCreated,'MM-DD-YYYY HH12:MI:SSAM')
 AS o_SalesOrderDateCreated,
TO_DATE(SalesOrderDateModified,'MM-DD-YYYY HH12:MI:SSAM')

 AS o_SalesOrderDateModified,
TO_DATE(DateShipped,'MM-DD-YYYY HH12:MI:SSAM') AS o_DateShipped,
IIF(Upper(IsShipped)='FALSE','0',IIF(Upper(IsShipped)='TRUE','1',IsShipped)) AS o_IsShipped,
InternalNotes AS InternalNotes,
PublicNotes AS PublicNotes,
AutoShip_DiscountAmount AS AutoShip_DiscountAmount,
OrderMerchantNotes AS OrderMerchantNotes,
IIF(Upper(IsRiskOrder)='FALSE','0',IIF(Upper(IsRiskOrder)='TRUE','1',IsRiskOrder)) AS o_IsRiskOrder,
RiskReasons AS RiskReasons,
OriginalShippingMethodCode AS OriginalShippingMethodCode,
IIF(Upper(IsShipHold)='FALSE','0',IIF(Upper(IsShipHold)='TRUE','1',IsShipHold)) AS o_IsShipHold,
...
ItemDescription AS ItemDescription,
ExtPrice AS ExtPrice,
TO_DATE(CustomerSalesOrderDetailDateCreated,'MM-DD-YYYY HH12:MI:SSAM') AS o_CustomerSalesOrderDetailDateCreated,
TO_DATE(CustomerSalesOrderDetailDateModified,'MM-DD-YYYY HH12:MI:SSAM') AS o_CustomerSalesOrderDetailDateModified,
HowdowegetyoutRx AS HowdowegetyoutRx,
VetCode AS VetCode,
PetCode AS PetCode,
IIF(Upper(IsOnHold1)='FALSE','0',IIF(Upper(IsOnHold1)='TRUE','1',IsOnHold1)) AS IsShipHold,
IIF(Upper(IsOnHoldToFill_C)='FALSE','0',IIF(Upper(IsOnHoldToFill_C)='TRUE','1',IsOnHoldToFill_C)) AS IsOnHoldToFill_C1,
SYSDATE AS LOAD_TSTMP,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_Shortcut_to_Allivet_Daily_Order_1""")

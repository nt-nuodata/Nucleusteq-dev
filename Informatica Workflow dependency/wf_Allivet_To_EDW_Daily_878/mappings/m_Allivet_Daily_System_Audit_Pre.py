...
df_2=spark.sql("""SELECT Operation AS Operation,
CustomerCode AS CustomerCode,
ExtraInfo AS ExtraInfo,
...
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_Shortcut_to_Allivet_Daily_System_Audit_1""")

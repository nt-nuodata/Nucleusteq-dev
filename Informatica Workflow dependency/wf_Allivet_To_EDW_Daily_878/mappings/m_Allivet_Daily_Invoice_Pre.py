...
df_2=spark.sql("""SELECT InvoicePostingDate AS i_InvoicePostingDate,
...
Pet_allergy AS Pet_allergy,
Pet_medical_conditions AS Pet_medical_conditions,
IIF ( ISNULL(Pet_is_pregnant), NULL, IIF(UPPER(Pet_is_pregnant)='Y',1,IIF(UPPER(Pet_is_pregnant)='N',0))) AS o_Pet_is_pregnant,
Vet_clinic_name AS Vet_clinic_name,
Veterinary_name AS Veterinary_name,
Vet_address AS Vet_address,
Vet_city AS Vet_city,
...
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_Shortcut_to_Allivet_Daily_Invoice_1""")

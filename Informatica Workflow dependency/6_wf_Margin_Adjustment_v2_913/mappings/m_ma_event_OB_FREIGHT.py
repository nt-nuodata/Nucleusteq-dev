...
df_4=spark.sql("""SELECT MA_EVENT_ID AS MA_EVENT_ID,
START_DT AS START_DT,
END_DT AS END_DT,
MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
MA_EVENT_SOURCE_ID AS MA_EVENT_SOURCE_ID,
...
LOAD_DT AS LOAD_DT,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_MA_OB_FREIGHT_CTRL_UPDATES_3""")
...
SEQ_MA_EVENT_ID.Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SEQ_MA_EVENT_ID INNER JOIN SQ_MA_OB_FREIGHT_CTRL_INSERTS_6 ON SEQ_MA_EVENT_ID.Monotonically_Increasing_Id = SQ_MA_OB_FREIGHT_CTRL_INSERTS_6.Monotonically_Increasing_Id
""")

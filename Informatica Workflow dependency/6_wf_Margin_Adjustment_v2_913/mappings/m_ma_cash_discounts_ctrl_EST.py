...
df_5=spark.sql("""SELECT VENDOR_ID AS VENDOR_ID,
iif(IS_NUMBER(TXT_EST_CASH_DISCOUNT_PCT), TO_DECIMAL(TXT_EST_CASH_DISCOUNT_PCT)*.01, 0) AS THIS_EST_CASH_DISCOUNT_PCT,
1 AS FLAG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_EST_CASH_DISCOUNT_PCT_4""")
...
1 AS FLAG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM SQ_Shortcut_To_DAYS_8""")
...
df_12=spark.sql("""SELECT FISCAL_MO AS FISCAL_MO,
VENDOR_ID AS VENDOR_ID,
THIS_EST_CASH_DISCOUNT_PCT AS THIS_EST_CASH_DISCOUNT_PCT,
SYSDATE AS UPDATE_TSTMP,
IIF(ISNULL(LOAD_TSTMP),SYSDATE,LOAD_TSTMP) AS LOAD_TSTMP,
IIF(ISNULL(FISCAL_MO),'I',IIF(THIS_EST_CASH_DISCOUNT_PCT <> IIF( ISNULL(EST_CASH_DISCOUNT_PCT),0,EST_CASH_DISCOUNT_PCT),'U','X')) AS INS_UPD_FLAG,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM JNR_MA_CASH_DISCOUNT_CTRL_11""")
...
FISCAL_MO AS FISCAL_MO,
VENDOR_ID AS SOURCE_VENDOR_ID,
VENDOR_ID AS SOURCE_VENDOR_ID,
THIS_EST_CASH_DISCOUNT_PCT AS EST_CASH_DISCOUNT_PCT,

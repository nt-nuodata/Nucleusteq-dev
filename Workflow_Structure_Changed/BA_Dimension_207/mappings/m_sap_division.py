...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sap_division")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_sap_division", variablesTableName, mainWorkflowId)
...
query_1 = f"""SELECT
  DISTINCT SAP_DIVISION_ID AS SAP_DIVISION_ID,
  SAP_DIVISION_DESC AS SAP_DIVISION_DESC,
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sap_division")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_sap_division", mainWorkflowId, parentName)

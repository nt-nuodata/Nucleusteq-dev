...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_SKU_Attr_Products_INS")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_SKU_Attr_Products_INS", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_SKU_ATTR1_0
...
df_0.createOrReplaceTempView("Shortcut_to_SKU_ATTR1_0")
...
FROM
  ...
  LEFT JOIN SQ_Shortcut_to_SKU_ATTR_1 DETAIL ON MASTER.PRODUCT_ID = DETAIL.PRODUCT_ID"""
...
SELECT
  ...
  SKU_SAP_MAP_DESC AS SKU_ATTR17_DESC,
  NULL AS SKU_ATTR18_ID,
  NULL AS SKU_ATTR18_DESC,
  NULL AS SKU_ATTR19_ID,
  NULL AS SKU_ATTR19_DESC,
  NULL AS SKU_ATTR20_ID,
  NULL AS SKU_ATTR20_DESC,
  NULL AS SKU_ATTR21_ID,
  NULL AS SKU_ATTR21_DESC,
  NULL AS SKU_ATTR22_ID,
  NULL AS SKU_ATTR22_DESC,
  NULL AS SKU_ATTR23_ID,
  NULL AS SKU_ATTR23_DESC,
  NULL AS SKU_ATTR24_ID,
  NULL AS SKU_ATTR24_DESC,
  NULL AS SKU_ATTR25_ID,
  NULL AS SKU_ATTR25_DESC,
  NULL AS SKU_ATTR26_ID,
  NULL AS SKU_ATTR26_DESC,
  NULL AS SKU_ATTR27_ID,
  NULL AS SKU_ATTR27_DESC,
  NULL AS SKU_ATTR28_ID,
  NULL AS SKU_ATTR28_DESC,
  NULL AS SKU_ATTR29_ID,
  NULL AS SKU_ATTR29_DESC,
  NULL AS SKU_ATTR30_ID,
  NULL AS SKU_ATTR30_DESC,
  NULL AS SKU_ATTR31_ID,
  NULL AS SKU_ATTR31_DESC,
  NULL AS SKU_ATTR32_ID,
  NULL AS SKU_ATTR32_DESC,
  NULL AS SKU_ATTR33_ID,
  NULL AS SKU_ATTR33_DESC,
  NULL AS SKU_ATTR34_ID,
  NULL AS SKU_ATTR34_DESC,
  NULL AS SKU_ATTR35_ID,
  NULL AS SKU_ATTR35_DESC,
  NULL AS SKU_ATTR36_ID,
  NULL AS SKU_ATTR36_DESC,
  NULL AS SKU_ATTR37_ID,
  NULL AS SKU_ATTR37_DESC,
  NULL AS SKU_ATTR38_ID,
  NULL AS SKU_ATTR38_DESC,
  NULL AS SKU_ATTR39_ID,
  NULL AS SKU_ATTR39_DESC,
  NULL AS SKU_ATTR40_ID,
  NULL AS SKU_ATTR40_DESC,
  NULL AS SKU_ATTR41_ID,
  NULL AS SKU_ATTR41_DESC,
  NULL AS SKU_ATTR42_ID,
  NULL AS SKU_ATTR42_DESC,
  NULL AS SKU_ATTR43_ID,
  NULL AS SKU_ATTR43_DESC,
  NULL AS SKU_ATTR44_ID,
  NULL AS SKU_ATTR44_DESC,
  NULL AS SKU_ATTR45_ID,
  NULL AS SKU_ATTR45_DESC,
  NULL AS SKU_ATTR46_ID,
  NULL AS SKU_ATTR46_DESC,
  NULL AS SKU_ATTR47_ID,
  NULL AS SKU_ATTR47_DESC,
  NULL AS SKU_ATTR48_ID,
  NULL AS SKU_ATTR48_DESC,
  NULL AS SKU_ATTR49_ID,
  NULL AS SKU_ATTR49_DESC,
  NULL AS SKU_ATTR50_ID,
  NULL AS SKU_ATTR50_DESC,
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_SKU_Attr_Products_INS")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_SKU_Attr_Products_INS", mainWorkflowId, parentName)

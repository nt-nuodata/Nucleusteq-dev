...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_national_cost_pre")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_national_cost_pre", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_To_NATIONAL_COST_FLAT_0
...
df_0.createOrReplaceTempView("Shortcut_To_NATIONAL_COST_FLAT_0")
...
FROM
  Shortcut_To_NATIONAL_COST_FLAT_0"""
...
query_5 = f"""SELECT
  SSTNCF1.DELETE_IND AS DELETE_IND,
  SSTNCF1.COND_TYPE_CD AS COND_TYPE_CD,
  ECVT4.VENDOR_ID AS VENDOR_ID,
  SSTNCF1.SKU_NBR AS SKU_NBR,
  SSTNCF1.PURCH_ORG_CD AS PURCH_ORG_CD,
  SSTNCF1.PURCH_INFO_CD AS PURCH_INFO_CD,
  ECED3.o_YYYYMMDD_END_DT_W_DEFAULT_TIME AS COND_END_DT,
  ECED2.o_YYYYMMDD_EFF_DT_W_DEFAULT_TIME AS COND_EFF_DT,
  SSTNCF1.COND_RECORD_NBR AS COND_RECORD_NBR,
  SSTNCF1.COND_AMT AS COND_AMT,
  SSTNCF1.PROMOTION_CD AS PROMOTION_CD,
  SSTNCF1.COND_RT_UNIT AS COND_RT_UNIT,
  SSTNCF1.COND_PRICE_UNIT AS COND_PRICE_UNIT,
  SSTNCF1.COND_UNIT AS COND_UNIT,
  SSTNCF1.UNIT_NUMERATOR AS UNIT_NUMERATOR,
  SSTNCF1.UNIT_DENOMINATOR AS UNIT_DENOMINATOR,
  ECED2.o_CURRENT_DATE_MINUS1 AS LOAD_DT,
  ECVT4.Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  EXP_COMMON_VENDOR_TRANS_4 ECVT4
  INNER JOIN EXP_COMMON_END_DT_3 ECED3 ON ECVT4.Monotonically_Increasing_Id = ECED3.Monotonically_Increasing_Id
  INNER JOIN SQ_Shortcut_To_NATIONAL_COST_FLAT_1 SSTNCF1 ON ECED3.Monotonically_Increasing_Id = SSTNCF1.Monotonically_Increasing_Id
  INNER JOIN EXP_COMMON_EFF_DATE_2 ECED2 ON SSTNCF1.Monotonically_Increasing_Id = ECED2.Monotonically_Increasing_Id
WHERE
  SSTNCF1.PURCH_INFO_CD = '0'"""
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_national_cost_pre")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_national_cost_pre", mainWorkflowId, parentName)

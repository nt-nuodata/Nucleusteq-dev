...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_SKU_Attr_UPD_TXS")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_SKU_Attr_UPD_TXS", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_SKU_TXS_ATTR_TYPE_VALUES_0
...
df_0.createOrReplaceTempView("Shortcut_to_SKU_TXS_ATTR_TYPE_VALUES_0")
...
FROM
  Shortcut_to_SKU_TXS_ATTR_TYPE_VALUES_0"""
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_SKU_TXS_ATTR_2
...
df_2.createOrReplaceTempView("Shortcut_to_SKU_TXS_ATTR_2")
...
WHERE
  IN(SKU_TXS_ATTR_TYPE_ID, 4, 5, 6, 7, 8, 9, 10)"""
...
FROM
  ...
  INNER JOIN Fil_SKU_TXS_Attr_Type_4 DETAIL ON MASTER.SKU_TXS_ATTR_TYPE_ID = DETAIL.SKU_TXS_ATTR_TYPE_ID
...
query_7 = f"""SELECT
  PRODUCT_ID AS PRODUCT_ID,
  FIRST(
    SKU_TXS_ATTR_TYPE_VALUE_ID,
    SKU_TXS_ATTR_TYPE_ID = 4
  ) AS SKU_ATTR4_ID,
  FIRST(
    SKU_TXS_ATTR_TYPE_VALUE_ID,
    SKU_TXS_ATTR_TYPE_ID = 5
  ) AS SKU_ATTR5_ID,
  FIRST(
    SKU_TXS_ATTR_TYPE_VALUE_ID,
    SKU_TXS_ATTR_TYPE_ID = 6
  ) AS SKU_ATTR6_ID,
  FIRST(
    SKU_TXS_ATTR_TYPE_VALUE_ID,
    SKU_TXS_ATTR_TYPE_ID = 7
  ) AS SKU_ATTR7_ID,
  FIRST(
    SKU_TXS_ATTR_TYPE_VALUE_ID,
    SKU_TXS_ATTR_TYPE_ID = 8
  ) AS SKU_ATTR8_ID,
  FIRST(
    SKU_TXS_ATTR_TYPE_VALUE_ID,
    SKU_TXS_ATTR_TYPE_ID = 9
  ) AS SKU_ATTR9_ID,
  FIRST(
    SKU_TXS_ATTR_TYPE_VALUE_ID,
    SKU_TXS_ATTR_TYPE_ID = 10
  ) AS SKU_ATTR10_ID,
  FIRST(
    SKU_TXS_ATTR_TYPE_VALUE_DESC,
    SKU_TXS_ATTR_TYPE_ID = 4
  ) AS SKU_ATTR4_DESC,
  FIRST(
    SKU_TXS_ATTR_TYPE_VALUE_DESC,
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_SKU_ATTR1_8
...
df_8.createOrReplaceTempView("Shortcut_to_SKU_ATTR1_8")
...
FROM
  ...
  LEFT JOIN Agg_SKU_TXS_Attr_7 DETAIL ON MASTER.PRODUCT_ID = DETAIL.PRODUCT_ID"""
...
USING
  Ups_SKU_Attr_12 AS SOURCE ON TARGET.PRODUCT_ID = SOURCE.PRODUCT_ID
  WHEN MATCHED THEN
UPDATE
SET
  TARGET.PRODUCT_ID = SOURCE.PRODUCT_ID,
  TARGET.SKU_ATTR4_ID = SOURCE.SKU_ATTR4_ID,
  TARGET.SKU_ATTR4_DESC = SOURCE.SKU_ATTR4_DESC,
  TARGET.SKU_ATTR5_ID = SOURCE.SKU_ATTR5_ID,
  TARGET.SKU_ATTR5_DESC = SOURCE.SKU_ATTR5_DESC,
  TARGET.SKU_ATTR6_ID = SOURCE.SKU_ATTR6_ID,
  TARGET.SKU_ATTR6_DESC = SOURCE.SKU_ATTR6_DESC,
  TARGET.SKU_ATTR7_ID = SOURCE.SKU_ATTR7_ID,
  TARGET.SKU_ATTR7_DESC = SOURCE.SKU_ATTR7_DESC,
  TARGET.SKU_ATTR8_ID = SOURCE.SKU_ATTR8_ID,
  TARGET.SKU_ATTR8_DESC = SOURCE.SKU_ATTR8_DESC,
  TARGET.SKU_ATTR9_ID = SOURCE.SKU_ATTR9_ID,
  TARGET.SKU_ATTR9_DESC = SOURCE.SKU_ATTR9_DESC,
  TARGET.SKU_ATTR10_ID = SOURCE.SKU_ATTR10_ID,
  TARGET.SKU_ATTR10_DESC = SOURCE.SKU_ATTR10_DESC,
  TARGET.UPDATE_TSTMP = SOURCE.UPDATE_TSTMP""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_SKU_Attr_UPD_TXS")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_SKU_Attr_UPD_TXS", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_site_profile_LOYALTY")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_site_profile_LOYALTY", variablesTableName, mainWorkflowId)
...
query_2 = f"""SELECT
  SP.LOCATION_ID,
  LP.PETSMART_DMA_CD,
  NVL(LP.LOYALTY_PGM_TYPE_ID, 0) AS LOYALTY_PGM_TYPE_ID,
  NVL(LP.LOYALTY_PGM_STATUS_ID, 0) AS LOYALTY_PGM_STATUS_ID,
  NVL(
    LP.LOYALTY_PGM_START_DT,
    TO_DATE(99991231, 'YYYYMMDD')
  ) AS LOYALTY_PGM_START_DT,
  NVL(
    LP.LOYALTY_PGM_CHANGE_DT,
    TO_DATE(99991231, 'YYYYMMDD')
  ) AS LOYALTY_PGM_CHANGE_DT,
  CURRENT_DATE
FROM
  Shortcut_to_SITE_PROFILE_1 SP,
  Shortcut_To_LOYALTY_PRE_0 LP
WHERE
...
query_3 = f"""SELECT
  LOCATION_ID AS LOCATION_ID,
  PETSMART_DMA_CD AS PETSMART_DMA_CD,
  LOYALTY_PGM_TYPE_ID AS IN_LOYALTY_PGM_TYPE_ID,
  LOYALTY_PGM_STATUS_ID AS IN_LOYALTY_PGM_STATUS_ID,
  LOYALTY_PGM_START_DT AS IN_LOYALTY_PGM_START_DT,
  LOYALTY_PGM_CHANGE_DT AS IN_LOYALTY_PGM_CHANGE_DT,
  IFF(
    LOYALTY_PGM_TYPE_ID = NULL,
    0,
    TO_INTEGER(LOYALTY_PGM_TYPE_ID)
  ) AS OUT_LOYALTY_PGM_TYPE_ID,
  IFF(
    LOYALTY_PGM_STATUS_ID = NULL,
    0,
    TO_INTEGER(LOYALTY_PGM_STATUS_ID)
  ) AS OUT_LOYALTY_PGM_STATUS_ID,
  IFF(
    LOYALTY_PGM_START_DT = NULL,
    to_date(TO_CHAR(12319999), 'MM/DD/YYYY'),
    LOYALTY_PGM_START_DT
  ) AS OUT_LOYALTY_PGM_START_DT,
  IFF(
    LOYALTY_PGM_CHANGE_DT = NULL,
    to_date(TO_CHAR(12319999), 'MM/DD/YYYY'),
    LOYALTY_PGM_CHANGE_DT
  ) AS OUT_LOYALTY_PGM_CHANGE_DT,
  UPDATE_DT AS UPDATE_DT,
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_site_profile_LOYALTY")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_site_profile_LOYALTY", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_label_size_ACTUAL")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_label_size_ACTUAL", variablesTableName, mainWorkflowId)
...
WHERE
  Shortcut_to_LABEL_DAY_STORE_SKU_2.UPDATE_TSTMP > CURRENT_DATE -1"""
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_label_size_ACTUAL")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_label_size_ACTUAL", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sku_profile_valuation_class")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_sku_profile_valuation_class", variablesTableName, mainWorkflowId)
...
query_1 = f"""SELECT
  DISTINCT VALUATION_CLASS_CD AS VALUATION_CLASS_CD,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_To_SKU_PROFILE_PRE_0
WHERE
  Shortcut_To_SKU_PROFILE_PRE_0.VALUATION_CLASS_CD > ' '"""
...
SELECT
  VALUATION_CLASS_CD AS VALUATION_CLASS_CD,
  VALUATION_CLASS_CD AS VALUATION_CLASS_DESC
FROM
  ASQ_SHORTCUT_TO_SKU_PROFILE_PRE_1""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sku_profile_valuation_class")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_sku_profile_valuation_class", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_PET_ALLERGIES_PRE")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_PET_ALLERGIES_PRE", variablesTableName, mainWorkflowId)
...
query_6 = f"""SELECT
  TO_INTEGER(LTRIM(RTRIM(AllergyId))) AS ALLERGY_ID,
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_PET_ALLERGIES_PRE")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_PET_ALLERGIES_PRE", mainWorkflowId, parentName)

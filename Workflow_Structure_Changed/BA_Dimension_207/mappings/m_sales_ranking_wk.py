...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sales_ranking_wk")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_sales_ranking_wk", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_SALES_RANKING_WK_PRE_0
...
df_0.createOrReplaceTempView("Shortcut_to_SALES_RANKING_WK_PRE_0")
...
FROM
  Shortcut_to_SALES_RANKING_WK_PRE_0"""
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sales_ranking_wk")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_sales_ranking_wk", mainWorkflowId, parentName)

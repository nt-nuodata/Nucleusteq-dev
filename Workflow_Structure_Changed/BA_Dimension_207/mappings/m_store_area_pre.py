...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_store_area_pre")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_store_area_pre", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_STORE_AREA_0
...
df_0.createOrReplaceTempView("Shortcut_to_STORE_AREA_0")
...
SELECT
  ...
  AREA_SQ_FT_AMT_35 AS AREA_35_SQ_FT_AMT
FROM
  EXP_STORE_AREA_PRE_2""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_store_area_pre")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_store_area_pre", mainWorkflowId, parentName)

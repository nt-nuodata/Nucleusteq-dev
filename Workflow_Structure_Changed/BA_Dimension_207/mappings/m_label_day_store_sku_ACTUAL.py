...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_label_day_store_sku_ACTUAL")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_label_day_store_sku_ACTUAL", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_ZTB_LABEL_CHGS_PRE_0
...
df_0.createOrReplaceTempView("Shortcut_to_ZTB_LABEL_CHGS_PRE_0")
...
FROM
  Shortcut_to_ZTB_LABEL_CHGS_PRE_0"""
...
query_6 = f"""SELECT
  ...
  LGPI5.PRODUCT_ID AS PRODUCT_ID,
  ...
  LGTD4.WEEK_DT AS WEEK_DT,
  LGTD4.FISCAL_WK AS FISCAL_WK,
  LGTD4.FISCAL_MO AS FISCAL_MO,
  LGTD4.FISCAL_YR AS FISCAL_YR,
  ELFC2.SUPPRESSED_FLAG AS SUPPRESSED_FLAG,
  ELFC2.LABEL_CNT AS LABEL_CNT,
  now() AS UPDATE_TSTMP,
  LGLI3.Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  LKP_GET_LOCATION_ID_3 LGLI3
  INNER JOIN LKP_GET_TIME_DIMENSIONS_4 LGTD4 ON LGLI3.Monotonically_Increasing_Id = LGTD4.Monotonically_Increasing_Id
  INNER JOIN LKP_GET_PRODUCT_ID_5 LGPI5 ON LGTD4.Monotonically_Increasing_Id = LGPI5.Monotonically_Increasing_Id
  INNER JOIN EXP_LBL_FIELDS_CONVERSION_2 ELFC2 ON LGPI5.Monotonically_Increasing_Id = ELFC2.Monotonically_Increasing_Id"""
...
WHERE
  Shortcut_to_LABEL_DAY_STORE_SKU1_7.ACTUAL_FLAG = 1
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_label_day_store_sku_ACTUAL")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_label_day_store_sku_ACTUAL", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sap_class")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_sap_class", variablesTableName, mainWorkflowId)
...
query_1 = f"""SELECT
  DISTINCT SAP_CLASS_ID AS SAP_CLASS_ID,
  SAP_CLASS_DESC AS SAP_CLASS_DESC,
  SAP_DEPT_ID AS SAP_DEPT_ID,
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sap_class")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_sap_class", mainWorkflowId, parentName)

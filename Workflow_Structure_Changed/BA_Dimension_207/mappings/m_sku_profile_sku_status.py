...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sku_profile_sku_status")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_sku_profile_sku_status", variablesTableName, mainWorkflowId)
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sku_profile_sku_status")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_sku_profile_sku_status", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_label_type_ADVANCE")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_label_type_ADVANCE", variablesTableName, mainWorkflowId)
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_label_type_ADVANCE")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_label_type_ADVANCE", mainWorkflowId, parentName)

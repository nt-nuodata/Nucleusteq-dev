...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sku_profile_subs_not_null")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_sku_profile_subs_not_null", variablesTableName, mainWorkflowId)
...
query_1 = f"""SELECT
  PRODUCT_ID AS PRODUCT_ID,
  NVL(SUBS_HIST_FLAG, 'N') AS SUBS_HIST_FLAG,
  NVL(SUBS_CURR_FLAG, 'N') AS SUBS_CURR_FLAG,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_To_SKU_PROFILE_0
WHERE
  SUBS_HIST_FLAG IS NULL
  OR (SUBS_CURR_FLAG) IS NULL"""
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sku_profile_subs_not_null")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_sku_profile_subs_not_null", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sap_dept")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_sap_dept", variablesTableName, mainWorkflowId)
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sap_dept")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_sap_dept", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_site_profile_HOTEL_OPEN_DT")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_site_profile_HOTEL_OPEN_DT", variablesTableName, mainWorkflowId)
...
# COMMAND ----------
# DBTITLE 1, Shortcut_To_SKU_PROFILE1_1
...
df_1.createOrReplaceTempView("Shortcut_To_SKU_PROFILE1_1")
...
query_3 = f"""SELECT
  ...
  CASE
    ...
    ) > 50 THEN MIN(SDSS.DAY_DT)
    ELSE NULL
  END HOTEL_OPEN_DT
FROM
  Shortcut_to_SALES_DAY_SKU_STORE_0 SDSS,
  Shortcut_To_SKU_PROFILE1_1 SP,
...
SELECT
  ...
  LOAD_DT AS LOAD_DT
FROM
  ASQ_Shortcut_To_SALES_DAY_SKU_STORE_VEND_3""")
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_site_profile_HOTEL_OPEN_DT")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_site_profile_HOTEL_OPEN_DT", mainWorkflowId, parentName)

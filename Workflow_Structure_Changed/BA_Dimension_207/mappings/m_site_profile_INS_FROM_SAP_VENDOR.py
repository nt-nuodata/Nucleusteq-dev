...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_site_profile_INS_FROM_SAP_VENDOR")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_site_profile_INS_FROM_SAP_VENDOR", variablesTableName, mainWorkflowId)
...
query_2 = f"""SELECT
  NEXT VALUE FOR LOCATION_ID_SEQ AS LOCATION_ID2,
  V.VENDOR_ID AS VENDOR_ID,
  V.VENDOR_NAME AS VENDOR_NAME,
  V.VENDOR_NBR AS VENDOR_NBR,
  V.LOCATION_ID AS LOCATION_ID,
  V.PARENT_VENDOR_ID AS PARENT_VENDOR_ID,
  V.ADDRESS AS ADDRESS,
  V.CITY AS CITY,
  V.STATE AS STATE,
  V.COUNTRY_CD AS COUNTRY_CD,
  V.ZIP AS ZIP,
  V.PHONE AS PHONE,
  RTRIM(LTRIM(V.LATITUDE)) AS LATITUDE,
  RTRIM(LTRIM(V.LONGITUDE)) AS LONGITUDE,
  NVL(V.ADD_DT, TO_DATE('99991231', 'YYYYMMDD')) AS ADD_DT,
  CURRENT_DATE AS UPDATE_DT,
  CURRENT_DATE AS LOAD_DT,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_VENDOR_PROFILE_1 V
  LEFT OUTER JOIN Shortcut_to_SITE_PROFILE_0 S ON LTRIM(RTRIM(V.VENDOR_NBR)) = LTRIM(RTRIM(S.LOCATION_NBR))
  AND S.LOCATION_TYPE_ID = 19
WHERE
  VENDOR_TYPE_ID IN (1, 2)
...
query_3 = f"""SELECT
  ...
  SUBSTR(ADDRESS, 1, 30) AS ADDRESS_OUT,
  SUBSTR(CITY, 1, 25) AS CITY_OUT,
  SUBSTR(STATE, 1, 3) AS STATE_OUT,
  COUNTRY_CD AS COUNTRY_CD,
  ZIP AS ZIP,
  PHONE AS PHONE,
  LATITUDE AS LATITUDE,
  ...
  'N' AS TP_LOC_FLAG,
  0 AS ZERO_DEFAULT,
  TO_DATE('9999/12/31', 'yyyy/mm/dd') AS DEFAULT_DT,
  9999 AS COMPANY_ID,
...
SELECT
  ...
  UPDATE_DT AS UPDATE_DT,
  LOAD_DT AS LOAD_DT FROMUPD_insert_4""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_site_profile_INS_FROM_SAP_VENDOR")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_site_profile_INS_FROM_SAP_VENDOR", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sku_store_cost_day")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_sku_store_cost_day", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_SKU_STORE_COST_DAY1_0
...
df_0.createOrReplaceTempView("Shortcut_to_SKU_STORE_COST_DAY1_0")

# COMMAND ----------
# DBTITLE 1, Shortcut_To_SKU_STORE_COST_PRE_1
...
df_1.createOrReplaceTempView("Shortcut_To_SKU_STORE_COST_PRE_1")
...
query_2 = f"""SELECT
  P.SKU_NBR AS SKU_NBR,
  P.STORE_NBR AS STORE_NBR,
  P.VENDOR_ID AS VENDOR_ID,
  P.PURCH_ORG_CD AS PURCH_ORG_CD,
  P.COND_TYPE_CD AS COND_TYPE_CD,
  P.PURCH_INFO_CD AS PURCH_INFO_CD,
  P.COND_END_DT AS COND_END_DT,
  P.DELETE_IND AS DELETE_IND,
  P.COND_EFF_DT AS COND_EFF_DT,
  P.COND_RECORD_NBR AS COND_RECORD_NBR,
  P.COND_AMT AS COND_AMT,
  P.PROMOTION_CD AS PROMOTION_CD,
  P.COND_RT_UNIT AS COND_RT_UNIT,
  P.COND_PRICE_UNIT AS COND_PRICE_UNIT,
  P.COND_UNIT AS COND_UNIT,
  P.UNIT_NUMERATOR AS UNIT_NUMERATOR,
  P.UNIT_DENOMINATOR AS UNIT_DENOMINATOR,
  P.LOAD_DT AS LOAD_DT,
  CASE
...
FROM
  Shortcut_To_SKU_STORE_COST_PRE_1 P
  LEFT OUTER JOIN Shortcut_to_SKU_STORE_COST_DAY1_0 S ON P.SKU_NBR = S.SKU_NBR
...
spark.sql("""MERGE INTO SKU_STORE_COST_DAY AS TARGET
USING
  UPD_Insert_Update_3 AS SOURCE ON TARGET.PURCH_ORG_CD = SOURCE.PURCH_ORG_CD
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sku_store_cost_day")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_sku_store_cost_day", mainWorkflowId, parentName)

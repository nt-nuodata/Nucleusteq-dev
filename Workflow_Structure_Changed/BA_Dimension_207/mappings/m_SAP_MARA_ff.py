...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_SAP_MARA_ff")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_SAP_MARA_ff", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_MARA_0
...
df_0.createOrReplaceTempView("Shortcut_to_MARA_0")
...
query_1 = f"""SELECT
  ...
  ALLOW_PMAT_IGNO AS ALLOW_PMAT_IGNO,
  MEDIUM AS MEDIUM,
  / BEV1 / LULEINH AS _BEV1_LULEINH,
  / BEV1 / LULDEGRP AS _BEV1_LULDEGRP,
  / BEV1 / NESTRUCCAT AS _BEV1_NESTRUCCAT,
  / DSD / SL_TOLTYP AS _DSD_SL_TOLTYP,
  / DSD / SV_CNT_GRP AS _DSD_SV_CNT_GRP,
  / DSD / VC_GROUP AS _DSD_VC_GROUP,
  / VSO / R_TILT_IND AS _VSO_R_TILT_IND,
  / VSO / R_STACK_IND AS _VSO_R_STACK_IND,
  / VSO / R_BOT_IND AS _VSO_R_BOT_IND,
  / VSO / R_TOP_IND AS _VSO_R_TOP_IND,
  / VSO / R_STACK_NO AS _VSO_R_STACK_NO,
  / VSO / R_PAL_IND AS _VSO_R_PAL_IND,
  / VSO / R_PAL_OVR_D AS _VSO_R_PAL_OVR_D,
  / VSO / R_PAL_OVR_W AS _VSO_R_PAL_OVR_W,
  / VSO / R_PAL_B_HT AS _VSO_R_PAL_B_HT,
  / VSO / R_PAL_MIN_H AS _VSO_R_PAL_MIN_H,
  / VSO / R_TOL_B_HT AS _VSO_R_TOL_B_HT,
  / VSO / R_NO_P_GVH AS _VSO_R_NO_P_GVH,
  / VSO / R_QUAN_UNIT AS _VSO_R_QUAN_UNIT,
  / VSO / R_KZGVH_IND AS _VSO_R_KZGVH_IND,
  PACKCODE AS PACKCODE,
  DG_PACK_STATUS AS DG_PACK_STATUS,
  MCOND AS MCOND,
  RETDELC AS RETDELC,
...
SELECT
  ...
  ALLOW_PMAT_IGNO AS ALLOW_PMAT_IGNO,
  MEDIUM AS MEDIUM,
  _BEV1_LULEINH AS / BEV1 / LULEINH,
  _BEV1_LULDEGRP AS / BEV1 / LULDEGRP,
  _BEV1_NESTRUCCAT AS / BEV1 / NESTRUCCAT,
  _DSD_SL_TOLTYP AS / DSD / SL_TOLTYP,
  _DSD_SV_CNT_GRP AS / DSD / SV_CNT_GRP,
  _DSD_VC_GROUP AS / DSD / VC_GROUP,
  _VSO_R_TILT_IND AS / VSO / R_TILT_IND,
  _VSO_R_STACK_IND AS / VSO / R_STACK_IND,
  _VSO_R_BOT_IND AS / VSO / R_BOT_IND,
  _VSO_R_TOP_IND AS / VSO / R_TOP_IND,
  _VSO_R_STACK_NO AS / VSO / R_STACK_NO,
  _VSO_R_PAL_IND AS / VSO / R_PAL_IND,
  _VSO_R_PAL_OVR_D AS / VSO / R_PAL_OVR_D,
  _VSO_R_PAL_OVR_W AS / VSO / R_PAL_OVR_W,
  _VSO_R_PAL_B_HT AS / VSO / R_PAL_B_HT,
  _VSO_R_PAL_MIN_H AS / VSO / R_PAL_MIN_H,
  _VSO_R_TOL_B_HT AS / VSO / R_TOL_B_HT,
  _VSO_R_NO_P_GVH AS / VSO / R_NO_P_GVH,
  _VSO_R_QUAN_UNIT AS / VSO / R_QUAN_UNIT,
  _VSO_R_KZGVH_IND AS / VSO / R_KZGVH_IND,
  PACKCODE AS PACKCODE,
  DG_PACK_STATUS AS DG_PACK_STATUS,
  MCOND AS MCOND,
  RETDELC AS RETDELC,
  ...
  ZZMETR_CTUNIT AS ZZMETR_CTUNIT
FROM
  SQ_Shortcut_to_MARA_1""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_SAP_MARA_ff")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_SAP_MARA_ff", mainWorkflowId, parentName)

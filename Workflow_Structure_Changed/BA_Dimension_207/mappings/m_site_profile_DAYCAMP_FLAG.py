...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_site_profile_DAYCAMP_FLAG")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_site_profile_DAYCAMP_FLAG", variablesTableName, mainWorkflowId)
...
query_1 = f"""SELECT
  ...
  CASE
    WHEN (MAX(sp.store_open_close_flag) = 'C') THEN MAX(sp.daycamp_flag)
    ELSE MAX(AA.daycamp_flag)
  END AS DAYCAMP_FLAG,
...
SET
  ...
  TARGET.DAYCAMP_FLAG = SOURCE.DAYCAMP_FLAG""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_site_profile_DAYCAMP_FLAG")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_site_profile_DAYCAMP_FLAG", mainWorkflowId, parentName)

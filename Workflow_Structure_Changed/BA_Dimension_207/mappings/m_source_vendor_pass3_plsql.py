...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_source_vendor_pass3_plsql")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_source_vendor_pass3_plsql", variablesTableName, mainWorkflowId)
...
query_2 = f"""SELECT
  'SOURCE_VENDOR_PASS3' AS MAPNAME,
...
FROM
  ASQ_Shortcut_To_Source_Vendor_2"""
...
query_7 = f"""SELECT
  ...
  var_COUNTER + 1 + 1 + 1 + 1 + 1 AS out_COUNTER,
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_source_vendor_pass3_plsql")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_source_vendor_pass3_plsql", mainWorkflowId, parentName)

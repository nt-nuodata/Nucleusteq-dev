...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_PET_CONDITION_PRE")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_PET_CONDITION_PRE", variablesTableName, mainWorkflowId)
...
query_6 = f"""SELECT
  TO_INTEGER(LTRIM(RTRIM(ConditionId))) AS CONDITION_ID,
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_PET_CONDITION_PRE")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_PET_CONDITION_PRE", mainWorkflowId, parentName)

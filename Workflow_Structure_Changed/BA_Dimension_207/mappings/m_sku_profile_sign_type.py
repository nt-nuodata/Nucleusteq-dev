...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sku_profile_sign_type")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_sku_profile_sign_type", variablesTableName, mainWorkflowId)
...
query_1 = f"""SELECT
  DISTINCT SIGN_TYPE_CD AS SIGN_TYPE_CD,
...
SELECT
  SIGN_TYPE_CD AS SIGN_TYPE_CD,
  SIGN_TYPE_CD AS SIGN_TYPE_DESC
FROM
  ASQ_Shortcut_To_SKU_PROFILE_PRE_1""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_sku_profile_sign_type")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_sku_profile_sign_type", mainWorkflowId, parentName)

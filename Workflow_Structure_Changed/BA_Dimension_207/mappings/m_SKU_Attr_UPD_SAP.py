...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_SKU_Attr_UPD_SAP")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_SKU_Attr_UPD_SAP", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_SKU_SAP_ATTR_0
...
df_0.createOrReplaceTempView("Shortcut_to_SKU_SAP_ATTR_0")
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_SKU_ATTR_2
...
df_2.createOrReplaceTempView("Shortcut_to_SKU_ATTR_2")
...
FROM
  ...
  INNER JOIN SQ_Shortcut_to_SKU_SAP_ATTR_1 DETAIL ON MASTER.PRODUCT_ID = DETAIL.PRODUCT_ID"""
...
query_5 = f"""SELECT
  ...
  IFF(ISNULL(LOAD_TSTMP), SYSTIMESTAMP(), LOAD_TSTMP) AS o_LOAD_TSTMP,
...
USING
  UPD_SKU_ATTR_6 AS SOURCE ON TARGET.PRODUCT_ID = SOURCE.PRODUCT_ID
  WHEN MATCHED THEN
UPDATE
SET
  TARGET.PRODUCT_ID = SOURCE.PRODUCT_ID,
  TARGET.SKU_ATTR3_ID = SOURCE.SKU_SAP_KOI_ID,
  TARGET.SKU_ATTR3_DESC = SOURCE.SKU_SAP_KOI_DESC,
  TARGET.SKU_ATTR11_ID = SOURCE.SKU_SAP_PROD_GROUP_ID,
  TARGET.SKU_ATTR11_DESC = SOURCE.SKU_SAP_PROD_GROUP_DESC,
  TARGET.SKU_ATTR12_ID = SOURCE.SKU_SAP_FAMILY_ID,
  TARGET.SKU_ATTR12_DESC = SOURCE.SKU_SAP_FAMILY_DESC,
  TARGET.SKU_ATTR13_ID = SOURCE.SKU_SAP_PPU_GROUP_ID,
  TARGET.SKU_ATTR13_DESC = SOURCE.SKU_SAP_PPU_GROUP_DESC,
  TARGET.SKU_ATTR14_ID = SOURCE.SKU_SAP_PRVT_LABEL_ID,
  TARGET.SKU_ATTR14_DESC = SOURCE.SKU_SAP_PRVT_LABEL_DESC,
  TARGET.SKU_ATTR15_ID = SOURCE.SKU_SAP_PRVT_LABEL_TIER_ID,
  TARGET.SKU_ATTR15_DESC = SOURCE.SKU_SAP_PRVT_LABEL_TIER_DESC,
  TARGET.SKU_ATTR16_ID = SOURCE.SKU_SAP_PRVT_LABEL_PARENT_TIER_ID,
  TARGET.SKU_ATTR16_DESC = SOURCE.SKU_SAP_PRVT_LABEL_PARENT_TIER_DESC,
  TARGET.SKU_ATTR17_ID = SOURCE.SKU_SAP_MAP_ID,
  TARGET.SKU_ATTR17_DESC = SOURCE.SKU_SAP_MAP_DESC,
  TARGET.UPDATE_TSTMP = SOURCE.o_UPDATE_TSTMP,
  TARGET.LOAD_TSTMP = SOURCE.o_LOAD_TSTMP""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_SKU_Attr_UPD_SAP")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_SKU_Attr_UPD_SAP", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_supply_chain_plsql")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_supply_chain_plsql", variablesTableName, mainWorkflowId)
...
# COMMAND ----------
# DBTITLE 1, Shortcut_To_SOURCE_VENDOR_PRE_1
...
df_1.createOrReplaceTempView("Shortcut_To_SOURCE_VENDOR_PRE_1")

# COMMAND ----------
# DBTITLE 1, Shortcut_To_SKU_SITE_PROFILE_2
...
df_2.createOrReplaceTempView("Shortcut_To_SKU_SITE_PROFILE_2")

# COMMAND ----------
# DBTITLE 1, Shortcut_To_QUERY_ARGUMENTS1_3
...
df_3.createOrReplaceTempView("Shortcut_To_QUERY_ARGUMENTS1_3")
...
query_4 = f"""SELECT
  'M_SUPPLY_CHAIN_PLSQL' AS JOB_NAME,
...
# COMMAND ----------
# DBTITLE 1, OUT_MPLT_GENERIC_SQL_17


query_5 = f"""SELECT
  JOB_NAME AS MAP_NAME
FROM
  ASQ_Shortcut_To_SUPPLY_CHAIN_4"""

df_5 = spark.sql(query_5)

df_5.createOrReplaceTempView("mGSmGS_Input")

# COMMAND ----------
# DBTITLE 1, INP_MPLT_GENERIC_SQL_6
...
query_9 = f"""SELECT
  ...
  var_COUNTER + 1 + 1 + 1 + 1 AS out_COUNTER,
...
df_17.createOrReplaceTempView("OUT_MPLT_GENERIC_SQL_17")

# COMMAND ----------
# DBTITLE 1, Shortcut_To_SKU_VENDOR_DAY_19
...
df_19.createOrReplaceTempView("Shortcut_To_SKU_VENDOR_DAY_19")

# COMMAND ----------
# DBTITLE 1, Shortcut_To_SUPPLY_CHAIN_20
...
df_20.createOrReplaceTempView("Shortcut_To_SUPPLY_CHAIN_20")

# COMMAND ----------
# DBTITLE 1, Shortcut_To_SKU_PROFILE_21
...
df_21.createOrReplaceTempView("Shortcut_To_SKU_PROFILE_21")

# COMMAND ----------
# DBTITLE 1, Shortcut_To_SKU_STORE_VENDOR_DAY_22
...
df_22.createOrReplaceTempView("Shortcut_To_SKU_STORE_VENDOR_DAY_22")
...
SELECT
  ...
  NULL AS EXEC_USER
FROM
  OUT_MPLT_GENERIC_SQL_17""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_supply_chain_plsql")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_supply_chain_plsql", mainWorkflowId, parentName)

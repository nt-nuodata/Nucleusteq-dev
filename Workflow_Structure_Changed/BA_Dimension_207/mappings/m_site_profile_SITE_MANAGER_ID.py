...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_site_profile_SITE_MANAGER_ID")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_site_profile_SITE_MANAGER_ID", variablesTableName, mainWorkflowId)
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_EMPLOYEE_PROFILE1_2
...
df_2.createOrReplaceTempView("Shortcut_to_EMPLOYEE_PROFILE1_2")
...
query_3 = f"""SELECT
  sep.employee_id AS EMPLOYEE_ID,
  sorg.location_id AS LOCATION_ID,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  (
    SELECT
    ...
    WHERE
      ...
      AND SUBSTR(h0.short, 5, 4) = l.store_nbr
  ) SORG
  JOIN (
    SELECT
      sh1.objid,
  ...
  ) SPOS ON sorg.objid = spos.objid
  LEFT OUTER JOIN Shortcut_to_EMPLOYEE_PROFILE1_2 SEP ON spos.sobid = sep.ps_position_id
ORDER BY
  1"""
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_EMPLOYEE_PROFILE11_5
...
df_5.createOrReplaceTempView("Shortcut_to_EMPLOYEE_PROFILE11_5")

# COMMAND ----------
# DBTITLE 1, ASQ_Shortcut_to_EMPLOYEE_PROFILE1_6
...
query_6 = f"""SELECT
  ...
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_EMPLOYEE_PROFILE11_5"""

df_6 = spark.sql(query_6)

df_6.createOrReplaceTempView("ASQ_Shortcut_to_EMPLOYEE_PROFILE1_6")
...
FROM
  ...
  INNER JOIN ASQ_Shortcut_to_EMPLOYEE_PROFILE1_6 DETAIL ON MASTER.DC_GM_EMAIL = DETAIL.EMPL_EMAIL_ADDR"""
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_SITE_PROFILE_8
...
df_8.createOrReplaceTempView("Shortcut_to_SITE_PROFILE_8")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_SITE_PROFILE_9
...
query_9 = f"""SELECT
  ...
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  Shortcut_to_SITE_PROFILE_8"""

df_9 = spark.sql(query_9)

df_9.createOrReplaceTempView("SQ_Shortcut_to_SITE_PROFILE_9")
...
FROM
  JNRTRANS_7 MASTER
  INNER JOIN SQ_Shortcut_to_SITE_PROFILE_9 DETAIL ON MASTER.STORE_NBR = DETAIL.STORE_NBR"""
...
df_11.createOrReplaceTempView("UPD_MANAGER_ID1_11")
...
USING
  UPD_MANAGER_ID_4 AS SOURCE ON TARGET.LOCATION_ID = SOURCE.LOCATION_ID
  WHEN MATCHED THEN
UPDATE
SET
  TARGET.LOCATION_ID = SOURCE.LOCATION_ID,
  TARGET.SITE_MANAGER_ID = SOURCE.EMPLOYEE_ID""")
...
spark.sql("""MERGE INTO SITE_PROFILE AS TARGET
USING
  UPD_MANAGER_ID1_11 AS SOURCE ON TARGET.LOCATION_ID = SOURCE.LOCATION_ID
  WHEN MATCHED THEN
UPDATE
SET
  TARGET.LOCATION_ID = SOURCE.LOCATION_ID,
  TARGET.SITE_EMAIL_ADDRESS = SOURCE.DC_GM_EMAIL,
  TARGET.SITE_MANAGER_ID = SOURCE.EMPLOYEE_ID""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_site_profile_SITE_MANAGER_ID")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_site_profile_SITE_MANAGER_ID", mainWorkflowId, parentName)

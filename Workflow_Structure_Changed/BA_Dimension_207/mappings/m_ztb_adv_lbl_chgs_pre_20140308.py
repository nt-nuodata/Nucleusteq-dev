...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_ztb_adv_lbl_chgs_pre_20140308")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_ztb_adv_lbl_chgs_pre_20140308", variablesTableName, mainWorkflowId)
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_ztb_adv_lbl_chgs_pre_20140308")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_ztb_adv_lbl_chgs_pre_20140308", mainWorkflowId, parentName)

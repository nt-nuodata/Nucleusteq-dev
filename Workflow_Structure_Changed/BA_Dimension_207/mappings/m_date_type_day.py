...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_date_type_day")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_date_type_day", variablesTableName, mainWorkflowId)
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_date_type_day")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_date_type_day", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_region_SITE_PROFILE_PRE")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_region_SITE_PROFILE_PRE", variablesTableName, mainWorkflowId)
...
query_1 = f"""SELECT
  NVL(MAX(REGION_DESC), 'Not Defined') REGION_DESC,
  REGION_ID
FROM
...
SELECT
  ...
  REGION_DESC AS REGION_DESC
FROM
  ASQ_SITE_PROFILE_PRE_1""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_region_SITE_PROFILE_PRE")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_region_SITE_PROFILE_PRE", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_Nz2Ora_site_profile")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_Nz2Ora_site_profile", variablesTableName, mainWorkflowId)
...
SELECT
  ...
  LOAD_DT AS LOAD_DT
FROM
  SQ_Shortcut_to_SITE_PROFILE1_1""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_Nz2Ora_site_profile")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_Nz2Ora_site_profile", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_location_area_END_DT")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_location_area_END_DT", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_STORE_AREA_PRE1_0
...
df_0.createOrReplaceTempView("Shortcut_to_STORE_AREA_PRE1_0")
...
query_3 = f"""SELECT
  LOCATION_1.LOCATION_ID AS LOCATION_ID,
  LOCATION_AREA_2.AREA_ID AS AREA_ID,
  LOCATION_AREA_2.LOC_AREA_EFF_DT AS LOC_AREA_EFF_DT,
  Shortcut_to_STORE_AREA_PRE1_0.STORE_NBR AS STORE_NBR,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  LOCATION_AREA_2,
  LOCATION_1,
  Shortcut_to_STORE_AREA_PRE1_0
WHERE
  LOCATION_1.LOCATION_ID = LOCATION_AREA_2.LOCATION_ID
  AND LOCATION_1.STORE_NBR = Shortcut_to_STORE_AREA_PRE1_0.STORE_NBR
  AND LOCATION_AREA_2.LOC_AREA_EFF_DT < CURRENT_DATE
  AND LOCATION_AREA_2.LOC_AREA_END_DT = TO_DATE('9999-12-31', 'YYYY-MM-DD')
ORDER BY
  1,
  2,
  3"""
...
query_4 = f"""SELECT
  ...
  AREA_ID AS AREA_ID,
  LOC_AREA_EFF_DT AS LOC_AREA_EFF_DT,
  ADD_TO_DATE(TRUNC(SESSSTARTTIME), 'DD', -1) AS LOC_AREA_END_DT,
  Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  ASQ_LOCATION_AREA_3"""
...
SELECT
  ...
  NULL AS SQ_FT_AMT
FROM
  EXP_STORE_AREA_PRE_DELETE_4""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_location_area_END_DT")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_location_area_END_DT", mainWorkflowId, parentName)

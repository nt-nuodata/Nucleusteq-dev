...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_label_pog_type_ACTUAL")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_label_pog_type_ACTUAL", variablesTableName, mainWorkflowId)
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_label_pog_type_ACTUAL")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_label_pog_type_ACTUAL", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_PET_GENDER_PRE")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_PET_GENDER_PRE", variablesTableName, mainWorkflowId)
...
query_6 = f"""SELECT
  TO_INTEGER(LTRIM(RTRIM(GenderId))) AS GENDER_ID,
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_PET_GENDER_PRE")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_PET_GENDER_PRE", mainWorkflowId, parentName)

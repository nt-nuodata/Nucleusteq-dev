...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_gl_mara_pre")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_gl_mara_pre", variablesTableName, mainWorkflowId)
...
query_1 = f"""SELECT
  CAST(MATNR AS NUMBER) AS SKU_NBR,
  M.ATTYP AS ARTICLE_CATEGORY_CD,
  monotonically_increasing_id() AS Monotonically_Increasing_Id
FROM
  SAPPR3.Shortcut_to_MARA_0 M
WHERE
  M.MANDT = 100
  AND NVL(
    LENGTH(TRIM(TRANSLATE(M.MATNR, '0123456789', ' '))),
    0
  ) = 0"""
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_gl_mara_pre")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_gl_mara_pre", mainWorkflowId, parentName)

...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_site_mktg_history")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_site_mktg_history", variablesTableName, mainWorkflowId)
...
query_2 = f"""SELECT
  ...
  CURRENT_DATE - 1 AS LOAD_DT_MINUS_ONE,
  SP.LOYALTY_PGM_CHANGE_DT AS LOYALTY_PGM_CHANGE_DT,
  SP.PETSMART_DMA_CD AS PETSMART_DMA_CD,
  SP.LOYALTY_PGM_TYPE_ID AS LOYALTY_PGM_TYPE_ID,
  SP.LOYALTY_PGM_STATUS_ID AS LOYALTY_PGM_STATUS_ID,
  CURRENT_TIMESTAMP AS REAL_LOAD_DT,
...
SELECT
  ...
  LOYALTY_PGM_TYPE_ID AS LOYALTY_PGM_TYPE_ID,
  LOYALTY_PGM_STATUS_ID AS LOYALTY_PGM_STATUS_ID,
  REAL_LOAD_DT AS LOAD_DT
FROM
  ASQ_Shortcut_To_SITE_PROFILE_2""")

# COMMAND ----------
#Post session variable updation
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_site_mktg_history")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_site_mktg_history", mainWorkflowId, parentName)

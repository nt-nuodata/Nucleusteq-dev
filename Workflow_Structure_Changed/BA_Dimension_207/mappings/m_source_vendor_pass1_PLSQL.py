...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_source_vendor_pass1_PLSQL")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_source_vendor_pass1_PLSQL", variablesTableName, mainWorkflowId)
...
query_2 = f"""SELECT
  'SOURCE_VENDOR_PASS1' AS MAP_NAME,
...
FROM
  SQ_Shortcut_To_SKU_VENDOR_DAY_2"""
...
query_7 = f"""SELECT
  ...
  var_COUNTER + 1 + 1 AS out_COUNTER,
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_source_vendor_pass1_PLSQL")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_source_vendor_pass1_PLSQL", mainWorkflowId, parentName)

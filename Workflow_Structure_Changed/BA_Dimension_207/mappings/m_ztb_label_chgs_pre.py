...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_ztb_label_chgs_pre")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_ztb_label_chgs_pre", variablesTableName, mainWorkflowId)
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_ztb_label_chgs_pre")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_ztb_label_chgs_pre", mainWorkflowId, parentName)

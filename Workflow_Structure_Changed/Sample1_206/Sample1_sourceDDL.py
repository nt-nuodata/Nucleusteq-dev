...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.TEST_LOCATIONS_V3S(LOCATION_ID INT,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_SUMMARY_V2S(LOCATION_ID_V2S INT,

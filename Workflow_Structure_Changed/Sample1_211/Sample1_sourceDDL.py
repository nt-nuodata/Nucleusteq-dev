...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_SUMMARY_V1S(LOCATION_ID INT,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.NUODATA_TEST_SUMMARY_V2(DC_NBR INT,
